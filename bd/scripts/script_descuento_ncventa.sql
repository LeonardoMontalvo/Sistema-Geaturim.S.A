...
VALUES ((select max(id_plan_cuentas)+1 from plan_cuentas), '4.1.09.03', '(-) DESCUENTO EN VENTAS POR CONCEPTO', 'G', 'Activo')returning id_plan_cuentas
),
y as(
INSERT INTO plan_cuentas(
id_plan_cuentas, codigo_plan, descripcion, cuenta, estado)
VALUES ((select id_plan_cuentas+1 from x), '4.1.09.03.01', '(-) DSCTOS EN VENTAS POR CONCEPTO', 'M', 'Activo') returning id_plan_cuentas
)
