...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(190, 5, utf8_decode("RESUMEN DE RETENCIONES EN LA FUENTE DE FACTURAS VENTAS"), 0, 1, 'C', 0);
...
$consulta1 = pg_query(
    ...
    AND fv.id_empresa='$_GET[id]' and rfv.fecha_actual $query_fecha '$_GET[fin]' order by rfv.id_retencion_fuente_factura_venta"
);
