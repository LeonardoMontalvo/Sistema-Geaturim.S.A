...
T.comprobante from transacciones T, usuario U, tipo_transaccion TT 
 where T.id_usuario=U.id_usuario and T.comprobante='$_GET[id]' and T.id_tipo_transaccion=TT.id_tipo_transaccion and T.concepto LIKE '%CxC%'");
...
and D.debito>'0.000'
and t.identificador_cli_pro='CxC'
order by
case
