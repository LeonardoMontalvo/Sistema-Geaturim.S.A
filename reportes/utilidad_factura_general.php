...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(210, 5, utf8_decode("UTILIDAD GENERAL DE LAS FACTURAS"), 0, 1, 'C', 0);
        ...
        $this->Cell(40, 6, utf8_decode('Tipo Documento'), 1, 0, 'C', 1);
...
if (pg_num_rows($sql1)) {$total = 0;
    ...
    $pdf->Cell(138, 6, utf8_decode('Total Utilidad'), 0, 0, 'R', 0);
