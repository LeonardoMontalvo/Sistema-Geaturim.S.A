...
//            $this->Cell(180, 5, "DIR.: ".utf8_decode($_SESSION['direccion']),0,1, 'C',0);                                
    ...
    $sql=pg_query("select detalle_gastos.cantidad,detalle_gastos.concepto,detalle_gastos.precio_compra,detalle_gastos.total_compra,detalle_gastos.cuenta_contable from gastos,detalle_gastos where gastos.id_gastos=detalle_gastos.id_gastos and detalle_gastos.id_detalle_gastos='$_GET[id]'");   
    while($row=pg_fetch_row($sql)){                
        $pdf->SetX(1);                  
