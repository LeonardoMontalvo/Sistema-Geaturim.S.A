        ...
        if($contador > 0){
            ...
            while($row1=pg_fetch_row($consulta1)){                                     
                ...
                if($row1[15] == "Activo"){       
                    ...
                    $pdf->Cell(15, 6, number_format($row1[10]-$row1[8]-$row1[9],2,'.',''),0,0, 'C',0);                                    
                    $desc=$desc+$row1[9];
                    $pdf->Cell(17, 6, number_format($row1[9],2,'.',''),0,0, 'C',0);                    
                    $pdf->Cell(16, 6, number_format($row1[6],2,'.',''),0,0, 'C',0);                    
                    $pdf->Cell(17, 6, number_format($row1[7],2,'.',''),0,0, 'C',0);                                                    
                    $ivaT=$ivaT+$row1[8];
                    $pdf->Cell(15, 6, number_format($row1[8],2,'.',''),0,0, 'C',0);                                    
                    $total=$total+$row1[10];
                    $t0 = $row1[6];
                    $pdf->Cell(15, 6, number_format($row1[10],2,'.',''),0,0, 'C',0);                    
