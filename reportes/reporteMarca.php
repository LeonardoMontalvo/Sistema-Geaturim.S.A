...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(210, 6, utf8_decode("LISTA DE PRODUCTOS POR MARCAS"), 0, 1, 'C', 0);
        $this->SetFont('helvetica', 'B', 10);
        $this->Cell(210, 7, utf8_decode("MARCA: " . $marca->obtenerMarca($_GET['id'])), 0, 1, 'C', 0);
...
$consulta = pg_query("SELECT codigo, articulo, iva_minorista, iva_mayorista, iva_negocio, stock from productos where id_marca='$_GET[id]';");
