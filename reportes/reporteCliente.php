...
session_start();
    ...
    <body>
        <header>
           <img src="../images/'.$_SESSION["parametros_empresa"]["logo_empresa"].'" />
            <div id="me">
                <h2 style="text-align:center;border:solid 0px;width:100%;">'.$_SESSION['nombre_empresa'].'</h2>
    ...
    <hr>
    <div id="linea">
        <h3>LISTA DE EQUIPOS DE RECIBIDOS POR CLIENTE </h3>
    </div>';
    ...
    $dompdf->stream('reporteCliente.pdf',array('Attachment'=>0));
?>
