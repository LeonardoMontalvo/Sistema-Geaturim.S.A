...
$pdf->SetX(5);
//=====================================================================================
$pdf->Cell(60, 5, utf8_decode('Iva Diferenciado%'), 0, 0, 'L', 0);//COMPRAS 1
...
$pdf->SetX(5);
//=====================================================================================
$pdf->Cell(60, 5, utf8_decode('Compras 5%'), 0, 0, 'L', 0);//COMPRAS 1
...
//======================================================================================
$pdf->Cell(25, 5, number_format($result_gasto_subtotal+$result_subtotal, 2, ',', '.'), 0, 0, 'R', 0);//BASE 2
