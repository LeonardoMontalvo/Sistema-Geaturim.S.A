...
while ($row = pg_fetch_row($consulta)) {
    $consulta1 = pg_query("select num_serie,factura_compra.fecha_actual,factura_compra.hora_actual,fecha_cancelacion,
    ...
    and factura_compra.fecha_actual between '$_GET[inicio]' and '$_GET[fin]' and factura_compra.estado='Activo' 
