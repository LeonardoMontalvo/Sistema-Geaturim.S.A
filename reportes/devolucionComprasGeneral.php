...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(210, 5, utf8_decode("RESUMEN DE DEVOLUCIÓN DE FACTURAS DE COMPRAS"), 0, 1, 'C', 0);
...
empresa_pro,identificacion_pro,representante_legal,id_devolucion_compra
        ...
        if (pg_num_rows($consulta1)) {
            while ($row1 = pg_fetch_row($consulta1)) {
                ...
                $pdf->Cell(24, 6, utf8_decode($row[2]), 0, 0, 'C', 0);
                $pdf->Cell(40, 6, utf8_decode(substr($row[3], 0, 19)), 0, 0, 'C', 0);
