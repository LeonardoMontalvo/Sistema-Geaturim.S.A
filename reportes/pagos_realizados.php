...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(210, 5, utf8_decode("PAGOS EXTERNOS REALIZADOS"), 0, 1, 'C', 0);
       ...
       /*  $this->SetFillColor(175, 215, 240);
        ...
        $this->Cell(30, 6, utf8_decode('Tipo Documento'), 1, 0, 'C', 1);
        $this->Cell(45, 6, utf8_decode('Nro Factura'), 1, 0, 'C', 1);
...
$id_usuario_fv = "";
if ($_GET['id'] != '0') {
    $id_usuario_fv = "and id_usuario='$_GET[id]'";
}
