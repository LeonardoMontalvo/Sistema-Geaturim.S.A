...
while ($row = pg_fetch_row($sql)) {
    ...
    $pdf->Cell(90, 6, maxCaracter(utf8_decode('RUC/CI:' . $row[33]), 35), 1, 0, 'L', 1);
    $pdf->Cell(115, 6, maxCaracter(utf8_decode('NOMBRES:' . $row[34]), 50), 1, 1, 'L', 1);
    $pdf->Ln(3);
...
$pdf->Ln(10);
$pdf->Cell(105, 6, "___________________________________", 0, 0, 'C', 0);
$pdf->Cell(105, 6, "___________________________________", 0, 1, 'C', 0);
$pdf->Output();
