...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $consulta = pg_query("select descripcion from retencion_iva where id_retencion_iva='$_GET[id_retencion]'");
        ...
        $this->Cell(22, 6, utf8_decode('Valor Factura'), 1, 0, 'C', 1);
        $this->Cell(22, 6, utf8_decode('Iva Factura'), 1, 0, 'C', 1);
...
$consulta1 = pg_query(
    ...
    AND ric.id_retencion_iva=ri.id_retencion_iva and ric.id_retencion_iva='$_GET[id_retencion]' 
    AND ric.fecha $query_fecha '$_GET[fin]' order by ric.id_retencion_iva_factura_compra"
);
...
if (pg_num_rows($consulta1)) {
    ...
    while ($row1 = pg_fetch_row($consulta1)) {
        ...
        $pdf->Cell(80, 6, utf8_decode(substr($row1[1], 0, 45)), 0, 0, 'C', 0);
        $pdf->Cell(22, 6, utf8_decode($row1[2]), 0, 0, 'C', 0);
        $pdf->Cell(22, 6, number_format($row1[3], 2, '.', ''), 0, 0, 'C', 0);
        $pdf->Cell(22, 6, number_format($row1[4], 2, '.', ''), 0, 0, 'C', 0);
