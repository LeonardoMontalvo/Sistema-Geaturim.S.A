        ...
        if(pg_num_rows($sql1)){
            while($row1=pg_fetch_row($sql1)) {
                if($row1[10]=='Contado') {
                    ...
                    $pdf->Cell(25, 6, number_format($row1[15],2,'.',''),0,0, 'C',0);                                         
                    $pdf->Cell(25, 6, number_format($row1[15],2,'.',''),0,0, 'C',0);                                     
                    $pdf->Cell(25, 6, number_format('0',2,'.',''),0,0, 'C',0);                                         
                    ...
                    while($row2=pg_fetch_row($sql2)){
                        ...
                        $pdf->Cell(25, 6, number_format($row2[15],2,'.',''),0,0, 'C',0);                                         
                        $pdf->Cell(25, 6, number_format($row1[15],2,'.',''),0,0, 'C',0);                                     
                        $pdf->Cell(30, 6, number_format('0',2,'.',''),0,0, 'C',0);                                         
