...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        $this->Cell(210, 5, utf8_decode("RESUMEN DE RETENCIONES DE IVA DE FACTURAS DE VENTAS"), 0, 1, 'C', 0);
...
$consulta1 = pg_query(
    "SELECT fv.num_factura, ri.descripcion, riv.fecha, riv.valor_factura, riv.iva_factura, riv.valor_retencion 
    FROM factura_venta fv, retencion_iva ri, retencion_iva_factura_venta riv 
    WHERE fv.id_factura_venta=riv.id_factura and riv.id_retencion_iva_factura_venta=ri.id_retencion_iva and riv.id_retencion_iva_factura_venta='$_GET[id_retencion]' 
    AND riv.fecha $query_fecha '$_GET[fin]' order by riv.id_retencion_iva_factura_venta"
);
