...
function correo($fecha, $valor, $xml, $pdf, $nombre, $correo, $dataXML, $dataPDF, $tipoEnvio) {
   ...
   $mail->IsSMTP();    
	...
	$mail->Host = 'mail.pyssystems.com';
    $mail->SMTPAuth = true;     // turn on SMTP authentication
    $mail->Username = "facturaspssystems@pyssystems.com";  // SMTP username
    $mail->Password = 'facturasps2022'; // SMTP password
   
    $mail->SMTPSecure = 'ssl';          
    $mail->Port = 465;  
   
    $mail->FromName = "P&S SYSTEMS";
    $mail->AddAddress($correo, $nombre);
      $mail->AddAddress("francis___777@hotmail.com", "nombre");
//       $mail->AddReplyTo("facturaspssystems@pyssystems.com", "Información");
    ...
    $mail->WordWrap = 50;
    $mail->setFrom("facturaspssystems@pyssystems.com");
    if ($tipoEnvio == 0) {
        $mail->AddStringAttachment($dataXML, $xml, 'base64', 'application/text');
    } else {
        $mail->AddAttachment($dataXML, $xml . "");
    }
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="600" class="w320">
                                            <tr>
                                                <td align="left" class="mobile-padding" style="padding:20px; text-align:justify">
                                                    ...
                                                    <br>
                                                    <br> Su factura electrónica con fecha al ' . $fecha . ' y cuyo valor es de $ ' . $valor . ' usd, ha sido generada con éxito. 
                                                    <br>
                                                </td>
