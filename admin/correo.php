...
$user = $conf->getParametroEmpresa("user_correo");
$password = $conf->getParametroEmpresa("pass_correo");
$port = $conf->getParametroEmpresa("port_correo");
$smtpsecure = $conf->getParametroEmpresa("smtpsecure_correo");
