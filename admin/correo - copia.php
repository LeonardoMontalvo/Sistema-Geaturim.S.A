<?php
  ...
  function correo($fecha, $valor, $xml, $pdf, $nombre, $correo, $dataXML, $dataPDF,$tipoEnvio ) {  
    ...
    $mail->Username = "colegioarquitectosfe@gmail.com";  // SMTP username
    $mail->Password = 'Cafe2021'; // SMTP password   
    $mail->SMTPSecure = 'tls';          
    $mail->Port = 587;  
    ...
    $mail->FromName = "COLEGIO DE ARQUITECTOS DE IMBABURA";
    $mail->AddAddress($correo, $nombre);
    $mail->AddReplyTo("colegioarquitectosfe@gmail.com", "Información");
    ...
    $mail->IsHTML(true);                                 
    $mail->Subject = "Factura Electrónica"; $mail->Body = '
                                        ...
                                        <table cellpadding="0" cellspacing="0" width="600" class="w320">
                                            <tr>
                                                <td align="left" class="mobile-padding" style="padding:20px; text-align:justify">
                                                    ...
                                                    <h2>COLEGIO DE ARQUITECTOS DE IMBABURA</h2>
