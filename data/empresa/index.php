...
<body class="skin-blue">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="col-md-4">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <label for="" style="margin-top: 15px;">Fecha Caducidad Firma:</label>
                                                                <input type="date" name="fecha_caducidad_firma" id="fecha_caducidad_firma" required class="form-control" />
    ...
    <script src="parametros_empresa.js?v=1.00" type="text/javascript"></script>
