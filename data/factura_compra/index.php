                                                        ...
                                                        <div class="row">
                                                            <div class="col-mx-12">
                                                                ...
                                                                <div class="col-md-1">
                                                                    <div class="form-group">
                                                                        <label>P.VENTA</label>
                                                                        <input type="text" name="precio_v" id="precio_v" class="form-control" placeholder="0.0000"/>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-mx-12">
                                                                ...
                                                                <div class="col-md-3">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="col-md-5" >I.C.E:</label>
                                                                        <div class="form-group col-md-7 no-padding">
                                                                            <div class="input-group">
                                                                                <div class="input-group-addon">
                                                                                    <i class="glyphicon glyphicon-usd"></i>
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="col-md-5" >I.R.B.P:</label>
                                                                        <div class="form-group col-md-7 no-padding">
                                                                            <div class="input-group">
                                                                                <div class="input-group-addon">
                                                                                    <i class="glyphicon glyphicon-usd"></i>
...
<!--                                                                <button class="btn btn-primary" id='btnCancelarRetenciones'><i class="icon-remove-sign"></i> Cancelar</button>-->
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <p>
                                                        ...
                                                        <!--<button class="btn bg-olive margin" id='btnContabilizar'><i class="fa fa-bank"></i> Contabilizar</button>-->
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div id="seguro" name="seguro" title="ADVERTENCIA">
                                                ...
                                                <center><button class="btn bg-olive margin" type="button" name="btnAceptar" id="btnAceptar"><i class="fa fa-arrow-right"></i> Aceptar</button>
                                                    <button class="btn bg-olive margin" type="button" name="btnSalir" id="btnSalir"><i class="fa fa-undo"></i> Salir</button></center>
                                            </div>
                                        </div>
                                    </div>
                                </div>
