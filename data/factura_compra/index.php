...
$consulta_fc = pg_query("select max(num_serie)  from factura_compra,  punto_venta_empresa where    
factura_compra.id_empresa=$campo_punto_ventaid ");
while ($row = pg_fetch_row($consulta_fc)) {
    $num_factura_fc = $row[0];
}
                                            ...
                                            <div class="tab-content" id="mitab">
                                                <div class="tab-pane active" id="tab_1">
                                                    <form id="clientes_form" name="clientes_form" method="post">
                                                        ...
                                                        <div style="margin-bottom: 25px; border: 1px solid black; border-radius:5px; padding:15px; display:none; flex-direction: column;">
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="form-group col-md-8 no-padding">
                                                                            <input type="text" name="serie" id="serie" required class="form-control" data-inputmask='"mask": "999999999"' data-mask />
                                                                            <input type="hidden" name="num_oculto" id="num_oculto" required class="form-control" value="<?php echo $num_factura_fc ?>" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-4" style="display: none;">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-group">
                                                                            ...
                                                                            <input type="hidden" name="id_proveedor" id="id_proveedor" value="1" required class="form-control" />
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="producto_dijitar" id="producto_dijitar" placeholder="Ingresar..." class="form-control" />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="col-md-1" style="display: none;" >
                                                                    ...
                                                                    <select class="form-control" name="tipo_iva" id="tipo_iva">
                                                                        <option id="iva_si" value="No">No</option>
                                                                        <option id="iva_no"  selected="" value="No">No</option>
                                                                    </select>
                                                                </div>
                                                                ...
                                                                <div class="col-md-1" style="display: none;" >
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="cantidad" id="cantidad" readonly="" value="1" class="form-control" value="1" placeholder="0.00" />
                                                                ...
                                                                <input type="hidden" name="iva_producto" id="iva_producto" value="No" readonly class="form-control" />
                                                                <div class="col-md-1"  style="display: none;">
                                                                    <div class="form-group">
                                                                        <label>DESC.</label>
...
<!--                                                                        <input type="text" name="fecha_emision" id="fecha_emision" placeholder="Buscar..." class="form-control" />-->
                                                                        <input type="date" name="fecha_emision" id="fecha_emision" required class="form-control" />
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-group" style="display: none;">
                                                                            ...
                                                                            <div class="form-group col-md-2 no-padding">
                                                                                <input type="text" name="num_items" id="num_items" value="1000" readonly class="form-control" value="<?php echo $campo_num_items ?>" />
                                                                        ...
                                                                        <div class="col-md-3">
                                                                            ...
                                                                            <div class="form-group col-md-8 no-padding">
                                                                                <input style="width:150px;height:110px; color:red; font-size:25px" type="text" name="totx" id="totx" value="0.000" readonly class="form-control" />
