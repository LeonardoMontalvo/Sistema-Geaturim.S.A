...
//         $("#punto_venta_inv").val(ui.item.punto_venta);
    ...
    jQuery("#list").jqGrid({
        ...
        colModel: [
            ...
            {name: 'cantidad', index: 'cantidad', editable: false, frozen: true, editrules: {required: true}, align: 'center', width: 70, editoptions: {maxlength: 10, size: 15, dataInit: function (elem) {
