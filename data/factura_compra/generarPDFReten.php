...
function generarPDFReten($id) {
    conectarse();
    $consulta = pg_query("SELECT nombre_empresa, ruc_empresa, direccion_empresa, propietario, obligacion, establecimiento,
   ...
   while ($row = pg_fetch_assoc($consulta)) {
    ...
    $pdf->SetY(50);
    $pdf->SetX(4);
    $pdf->multiCell(60, 5, 'Dir Sucursal: ' . utf8_decode($direccionEstablecimiento), 0); //	 direccion	
