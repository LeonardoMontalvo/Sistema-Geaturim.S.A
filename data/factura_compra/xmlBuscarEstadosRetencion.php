...
if ($start < 0)
    $start = 0;
if ($search == 'false') {
    $SQL = "SELECT RF.id_retencion_fuente_factura_compra,fc.num_serie,rf.num_serie, FC.fecha_emision, P.empresa_pro, RF.num_autorizacion, FC.total_compra, RF.estado,FC.id_factura_compra
