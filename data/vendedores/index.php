          ...
          <div class="row">
            <div class="col-md-12">
              <div class="box box-primary">
                <div class="box-body">
                  <div class="row">
                      <form id="vendedores_form" name="vendedores_form" method="post">
                        <div class="col-mx-12">                    
                          <div class="col-md-4">
                            

                            <div class="form-group">
                              <label>CI: <font color="red">*</font></label>
                          ...
                          <div class="col-md-4">
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="direccion_vend" id="direccion_vend" placeholder="Dirección" class="form-control" />
                            </div>
                  ...
                  <div class="row">
                    ...
                    <div id="vendedores" title="Búsqueda de Vendedores" class="">
                ...
                <div id="clave_permiso_ven" title="PERMISOS">
                    ...
                    <div id="seguro_ven">
                        <label>¿Está seguro de eliminar al vendedores?</label>  
                        <br />
