...
<html>
  <head>
    <meta charset="UTF-8">
    <title>APROBAR ORDENES DE PRODUCCION</title>
  ...
  <body class="skin-blue">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        <section class="content-header">
          <h1>
            APROBAR ORDENES DE PRODUCCIÓN
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Procesos</a></li>
            <li class="active">Aprobar Ordenes de Producción</li>
          </ol>
        </section>
                              ...
                              <div class="col-md-3">
                                <div class="form-group">
                                  ...
                                  <div class="input-group">
                                    ...
                                    <input type="hidden" name="cantidad" id="cantidad" readonly class="form-control"/>
                  ...
                  <div class="row">
                   <div class="col-mx-12">
                    <p>
                      ...
                      <button class="btn bg-olive margin" id='btnAprobar'><i class="fa fa-check"></i> Aprobar</button>
                      <button class="btn bg-olive margin" id='btnNoAprobar'><i class="fa fa-remove"></i> NO Aprobar</button>
                    </p> 
                   </div>                           
                  </div>
                </div>
    ...
    <script src="aprobar_orden.js" type="text/javascript"></script>
