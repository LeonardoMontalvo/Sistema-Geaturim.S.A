...
function inicio() {
    ...
    jQuery("#list1").jqGrid({
        ...
        colModel: [
            ...
            {name: 'descripcion_r', index: 'descripcion_r', editable: true, align: 'left', width: '550', search: true, frozen: true, formoptions: {elmsuffix: " (*)"}, editrules: {required: true}},
            {name: 'valor_r', index: 'valor_r', editable: true, align: 'center', width: '80', search: true, frozen: true, formoptions: {elmsuffix: " (*)"}, editrules: {required: true}},
    ...
    jQuery("#list").jqGrid({
        ...
        colModel: [
            ...
            {name: 'descripcion', index: 'descripcion', editable: true, align: 'left', width: '550', search: true, frozen: true, formoptions: {elmsuffix: " (*)"}, editrules: {required: true}},
            {name: 'valor', index: 'valor', editable: true, align: 'center', width: '80', search: true, frozen: true, formoptions: {elmsuffix: " (*)"}, editrules: {required: true}},
