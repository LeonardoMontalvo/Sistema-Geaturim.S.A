...
<html>
    <head>
        <meta charset="UTF-8">
        <title>RETENCIONES EN LA FUENTE</title>
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Retenciones en la Fuente</li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-12">
                            <div class="nav-tabs-custom">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a href="#tab_1" data-toggle="tab">Retenciones en la Fuente</a></li>
                                    <li><a href="#tab_2" data-toggle="tab">Retenciones en la Fuente Recibidas</a></li>
                                </ul>
                                <div class="box-body">
                                    <div class="row">
