...
error_reporting(0);
$cont11 = 0;
$consulta = pg_query("select max(comprobante::int) from inventario");
                                                ...
                                                <div class="col-mx-12">
                                                    ...
                                                    <div class="col-md-2">
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" name="tipo_inventario" id="tipo_inventario">
                                                                <option value="0">SELECCIONE..</option>
                                                                <option value="sumar">SUMAR</option>
                                                                <option id="tipo_inven" value="reemplazar" selected>REEMPLAZAR STOCK</option>
                                                            </select>
