...
if(pg_query("Update rutas Set nombre_ruta='".strtoupper($_POST['nombre_ruta'])."', descripcion_ruta='$_POST[nombre]', id_vendedor='$_POST[id_vendedor]', frecuencia_vicitas='$_POST[frecuencia]' where id_ruta='$_POST[id_rutas]'")){
   $data = 1;
}
// Auditoria
