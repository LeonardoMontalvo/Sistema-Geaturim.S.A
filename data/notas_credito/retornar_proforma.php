...
if ($_GET[tipo] == "FACTURA") {
    $consulta = pg_query("select P.cod_productos, P.codigo, P.articulo, D.cantidad, D.cantidad, D.precio_venta, D.descuento_producto, D.total_venta, P.iva, P.incluye_iva, P.inventariable from productos P, detalle_factura_venta D, factura_venta PR where P.cod_productos = D.cod_productos and PR.id_factura_venta = D.id_factura_venta and PR.estado ='Activo'  and D.estado= 'Activo' and PR.id_factura_venta='" . $id . "'");
 ...
 D.total_venta, P.iva, P.incluye_iva, P.inventariable from productos P, detalle_facturas_novalidas D, facturas_novalidas PR 
