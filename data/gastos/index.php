...
$cont1 = 0;
$consulta = pg_query("select * from gastos_internos order by id_gastos asc");
    ...
    <div class="content-wrapper">
      <section class="content-header">
        ...
        <ol class="breadcrumb">
          ...
          <li class="active">Gastos internos</li>
        </ol>
      </section>
                    ...
                    <form id="clientes_form" name="clientes_form" method="post">
                      <div class="row">
                        ...
                        <div class="col-md-2">
                          <div class="form-group">
                            <label>Estado:</label>
                            <input type="text" name="estado" id="estado" readonly value="" class="form-control" />
                          </div>
                        </div>
                      </div>
                  </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <p>
                    ...
                    <button class="btn bg-olive margin" id='btnEliminar'><i class="fa fa-trash-o"></i> Eliminar</button>
