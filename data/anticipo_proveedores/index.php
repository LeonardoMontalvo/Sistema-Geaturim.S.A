...
$consulta=pg_query("select max(comprobante) from anticipo_proveedores");
while($row=pg_fetch_row($consulta))
 {
  $num_nota_credito=$row[0];
 }
$consulta=pg_query("select max(comprobante)  from anticipo_proveedores,  punto_venta_empresa where    
anticipo_proveedores.id_empresa=$campo_punto_ventaid  and punto_venta_empresa.id_usuario='$_SESSION[id]'  ");
while($row=pg_fetch_row($consulta))
 {
   $num_nota_credito=$row[0];
 }
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Anticipo proveedores</li>
                    </ol>
                </section>
...
<input type="hidden" name="num_oculto"  id="num_oculto" required class="form-control" value="<?php echo $num_nota_credito ?>" />  
                                    ...
                                    <div id="buscar_anticipo_cliente" title="BUSCAR ANTICIPO PROVEEDORES">
        ...
        <script src="anticipo_proveedores.js" type="text/javascript"></script>
