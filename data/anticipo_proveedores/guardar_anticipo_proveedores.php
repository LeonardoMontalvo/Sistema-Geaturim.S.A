...
$cont = 0;
$consulta = pg_query("select max(id_anticipo_proveedores) from anticipo_proveedores");
...
//echo '<br>GUARDAR FACTURA VENTA: <br>' . "insert into anticipo_proveedores values('$cont', '$_POST[id_proveedor]', '$_SESSION[PV]', '$_SESSION[id]' , '$_POST[idCuenta]','$_POST[secuencial]' ,'$_POST[fecha_actual]' ,'$_POST[hora_actual]' ,'$total','$_POST[formaspago_mixto]','$_POST[fecha_registro]','$_POST[comentario]','Activo')"; //////////////////////////
//	 
pg_query("insert into anticipo_proveedores values('$cont', '$_POST[id_proveedor]', '$_SESSION[PV]', '$_SESSION[id]' , '$_POST[idCuenta]','$_POST[secuencial]' ,'$_POST[fecha_actual]' ,'$_POST[hora_actual]' ,'$total','$_POST[formaspago_mixto]','$_POST[fecha_registro]','$_POST[comentario]','Activo')");
...
$prove = pg_query("select identificacion_pro from proveedores where id_proveedor='$cliente1'");
...
if ($_POST['formaspago_mixto'] == "Contado" ) {
...
if ($_POST['formaspago_mixto'] == "Cheque") {
...
//    echo '<br>GUARDAR FACTURA VENTA3345HHG: <br>' . "insert into detalle_transaccion values('" . $fila1[0] . "','" . $fila[0] . "','" . $buscaCuenta[0] . "','" . $_POST['monto'] . "','0.000','Activo')"; //////////////////////////
    ...
    pg_query("insert into detalle_transaccion values('" . $fila1[0] . "','" . $fila[0] . "','$id_cuenta_banco','0.000','" . $_POST['monto'] . "','Activo')");
}
...
$sql = pg_query("SELECT * FROM plan_cuentas where descripcion like '%ANTICIPO A PROVEEDORES%'");
$buscaCuenta = pg_fetch_row($sql);
$fila1[0] = $fila1[0] + 1;
