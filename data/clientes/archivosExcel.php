                            ...
                            <div class="widget ">
                                ...
                                <div class="widget-content">
                                    ...
                                    <div class="tabbable" id="centro">
                                        <form id="formulario_excel_cli" name="formulario_excel_cli" method="post" class="form">
                                            <fieldset>
                                                <table cellpadding="2" border="0" style="margin-left: 10px;">
                                                    <tr>
                                                        <td><label for="archivo_excel" style="width: 20%">Seleccione: </label></td>   
                                                        <td><input type="file" name="archivo_excel_cli" id="archivo_excel_cli" class="campo" readonly style="width: 500px"/></td>
                                                        <td><button class="btn btn-primary" id='btnGuardarCargar_cli'><i class="icon-save"></i> Guardar y Cargar</button></td>
                                                    </tr>  
                                                </table>  
                                            </fieldset>
                                        </form>
...
<!--                                    <div style="width:100%;height:300px;border:solid 0px;border-color:rgb(204, 201, 201);overflow:scroll;">
                                        <table style="width:100%;" class="table table-bordered table-hover table-condensed" id="tabla_excel" >
                                            ...
                                            <tbody>
                                              ...
                                              <div style="width:100%;height:300px;border:solid 0px;border-color:rgb(204, 201, 201);overflow:scroll;">
                                        <table style="width:100%;" class="table table-bordered table-hover table-condensed" id="tabla_excel_cli" >
                                            <thead>
                                                <tr>
