...
if ($start < 0)
    $start = 0;
if ($search == 'false') {
    $SQL = "select * from plan_cuentas where cuenta='M' and  (descripcion like '%BANCO%' or descripcion like '%MUTU%') and codigo_plan  like '%1.1%'  ORDER BY $sidx $sord offset $start limit $limit";
} else {
