...
if($_POST[serie]!=""){
   ...
   pg_query("Update devolucion_compra Set  id_proveedor = '$_POST[id_proveedor]', id_usuario = '$_SESSION[id]', fecha_actual = '$_POST[fecha_actual]', hora_actual = '$_POST[hora_actual]', num_autorizacion_sri = '$_POST[fecha_registro_nc]'
    ,   tipo_comprobante = '$_POST[tipo_comprobante]',num_serie= '$_POST[serie]',num_autorizacion = '$_POST[autorizacion]', observaciones = '$_POST[observaciones]', num_nota_credito= '$_POST[secuencial_nc]', motivo= '$_POST[autorizacion_nc]'
    , tarifa0 = '$_POST[tarifa0]', tarifa12 = '$_POST[tarifa12]', iva_compra = '$_POST[iva]', descuento_compra = '$_POST[desc]', total_compra = '$_POST[tot]' where id_devolucion_compra = '$_POST[comprobante]'");
    // fin}
}
else    
{
        ...
        // modificar factura compra
      pg_query("Update devolucion_compra Set  id_proveedor = '$_POST[id_proveedor]', id_usuario = '$_SESSION[id]', fecha_actual = '$_POST[fecha_actual]', hora_actual = '$_POST[hora_actual]', num_autorizacion_sri = '$_POST[fecha_registro_nc]'
    ,   tipo_comprobante = '$_POST[tipo_comprobante]',num_serie= '$_POST[secuencial]',num_autorizacion = '$_POST[autorizacion_credito]', observaciones = '$_POST[observaciones]', num_nota_credito= '$_POST[secuencial_nc]', motivo= '$_POST[autorizacion_nc]'
    , tarifa0 = '$_POST[tarifa0]', tarifa12 = '$_POST[tarifa12]', iva_compra = '$_POST[iva]', descuento_compra = '$_POST[desc]', total_compra = '$_POST[tot]' where id_devolucion_compra = '$_POST[comprobante]'");
    // fin
}
    ...
    $consulta = pg_query("select * from detalle_devolucion_compra where id_devolucion_compra = '$_POST[comprobante]'");
...
//        pg_query("Update productos Set stock='".$cal1."' where cod_productos='".$id."'");
        ...
        pg_query("insert into kardex_valorizado values('$cont_v','$id','$_POST[fecha_actual]', '". 'Mod D.Compra: '.$_POST['serie']."','','".$cantidad_entrada."','".$cantidad."','".$precio_unitario_entrada."','".$precio_total_entrada."','','','".$cantidad_total."','".$precio_unitario_total."','".$precio_total_total."','".$arreglo1[$i]."','3')");
        
        // fin
           
        // guardar kardex
        pg_query("insert into kardex values('$cont_k','$_POST[fecha_actual]', '" . 'Mod D.C:' . $_POST['serie'] . "' ,'$canti1','$precio_unitario_entrada','$precio_total_entrada','$id','$cal1','1','','','$_POST[id_proveedor]','$_POST[comprobante]','DV')");
        // fin
    }
    // fin suma
    $nelem = count($arreglo1);
    // eliminar detalle productos
    pg_query("DELETE FROM  detalle_devolucion_compra where id_devolucion_compra = '$_POST[comprobante]'");
    // fin  
    ...
    $valor_Servicio='';
       $consulta_bien_servi = pg_query(" select bien_servicios from productos where cod_productos='$arreglo1[$i]'");
        ...
        pg_query("insert into detalle_devolucion_compra values('$cont4','$_POST[comprobante]','$arreglo1[$i]','$arreglo2[$i]','$arreglo3[$i]','$arreglo4[$i]','$arreglo5[$i]','Activo')");
        // fin 
...
//           
//        // guardar kardex
//        pg_query("insert into kardex values('$cont_k','$_POST[fecha_actual]', '" . 'M. D. C:' . $_POST['serie'] . "' ,'$arreglo2[$i]','$arreglo3[$i]','$arreglo5[$i]','$arreglo1[$i]','$cal','1','','')");
        // fin
    }
