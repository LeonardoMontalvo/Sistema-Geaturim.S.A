...
<!--                              
                                <div class="col-md-4">
                                  <div class="form-group">
                                    ...
                                    <div class="form-group col-md-7 no-padding">                                
                                      <input type="text" name="fecha_registro_credito"  id="fecha_registro_credito" required  class="form-control" />
                                    </div> 
                                  </div>
                                </div>                            -->
                              ...
                              <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                  <div class="form-group">
                                    <label class="col-md-5">Fecha registro:</label>
                                    <div class="form-group col-md-7 no-padding">                                
                                      <input type="text" name="fecha_registro_nc"  id="fecha_registro_nc" required  class="form-control" />
                                    </div> 
                                  </div>
                                </div>                            
