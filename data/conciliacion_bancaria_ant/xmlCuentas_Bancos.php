...
if ($start < 0)
    $start = 0;
if ($search == 'false') {
    $SQL = "select c.id_cuenta_banco, c.numero_cuenta, b.descripcion, p.codigo_plan from cuentas_bancos c, bancos b, plan_cuentas p where c.id_banco=b.id_bancos and c.id_plan_cuentas=p.id_plan_cuentas ORDER BY $sidx $sord offset $start limit $limit";
} else {
