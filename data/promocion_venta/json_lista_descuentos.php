...
$SQL = "SELECT id_promocion_venta, nombre_categoria,promocion_venta.id_categoria, descripcion, fecha_desde, fecha_hasta,porcentaje_promocion,promocion_venta.estado,todos_id_categoria 
FROM promocion_venta left join categoria on promocion_venta.id_categoria= categoria.id_categoria where promocion_venta.estado='Activo'";
