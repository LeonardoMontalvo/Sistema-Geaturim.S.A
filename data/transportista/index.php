...
<html>
  ...
  <body class="skin-blue">
      ...
      <div class="content-wrapper">
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Transportista</li>
          </ol>
        </section>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="box box-primary">
                <div class="box-body">
                  <div class="row">
                      <form id="transportista_form" name="transportista_form" method="post">
                        <div class="col-mx-12">                    
                          <div class="col-md-4">
                      ...
                      <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" name="telefono" id="telefono" class="form-control" data-inputmask='"mask": "(999) 999-999"' data-mask/>
                              </div>
                            </div>

                            <div class="form-group">
                              <label>Num Placa:<font color="red">*</font></label>
                              <div class="form-group">
                               
                                <input type="text" name="num_placa" id="num_placa" placeholder="Num Placa" class="form-control"/>
                              </div>
                            </div>
                          ...
                          <div class="col-md-4">
                           ...
                           <div class="form-group">
                              ...
                              <input type="text" name="nombres_trans" id="nombres_trans"  class="form-control" />
                            </div>

                            <div class="form-group">
                              <label>Dirección: <font color="red">*</font></label>
                              <input type="text" name="direccion_trans" id="direccion_trans" placeholder="Dirección" class="form-control" />
                            </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="input-group">
                                ...
                                <input type="text" name="celular" id="celular" class="form-control" data-inputmask='"mask": "(999) 999-9999"' data-mask/>
                              </div>
                            </div>
                  ...
                  <div class="row">
                    ...
                    <div id="transportista" title="Búsqueda de Transportista" class="">
                ...
                <div id="clave_permiso_ven" title="PERMISOS">
                    ...
                    <div id="seguro_ven">
                        <label>¿Está seguro de eliminar al transportista?</label>  
                        <br />
    ...
    <script src="transportista.js" type="text/javascript"></script>
