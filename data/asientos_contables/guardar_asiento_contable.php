...
if ($_POST['id_tipo_transaccion'] == "3") {
    ...
    if ($_POST['tipo_pago'] == "EXTERNA") {
        ...
        for ($i = 1; $i < $nelem; $i++) {
            ...
            $cont1++;
            ////////////guardar pagos//////// 
            pg_query("insert into pagos_pagar values('$cont1','$_POST[id_cliente]','$_SESSION[id]','" . $cont[0] . "','$_POST[fecha_actual]','$_POST[hora_actual]','$_POST[forma_pago]','$_POST[tipo_pago]','$_POST[num_factura]','FACTURA','$_POST[fecha_factura]','$_POST[totalcxc]','$_POST[valor_pagado]','$_POST[saldo2]','$_POST[observaciones]','Activo','$_POST[ids_fac_cp]')");
        ...
        //	 echo '<br>GUARDAR FACTURA VENTA1: <br>' . "insert into pagos_pagar values('$cont1','$_POST[id_cliente]','$_SESSION[id]','" . $cont[0] . "','$_POST[fecha_actual]','$_POST[hora_actual]','$_POST[forma_pago]','$_POST[tipo_pago]','$_POST[num_factura]','FACTURA','$_POST[fecha_factura]','$_POST[totalcxc]','$_POST[valor_pagado]','$_POST[saldo2]','$_POST[observaciones]','Activo','$_POST[ids_fac_cp]')";//////////////////////////
    ...
    if ($_POST['tipo_pago'] == "EXTERNA") {
        ...
        for ($i = 1; $i < $nelem; $i++) {
            ...
            ////////////guardar pagos////////
            //        pg_query("insert into pagos_pagar values('$cont1','$_POST[id_cliente]','$_SESSION[id]','" . $cont[0] . "','$_POST[fecha_actual]','$_POST[hora_actual]','$_POST[forma_pago]','$_POST[tipo_pago]','$_POST[num_factura]','FACTURA','$_POST[fecha_factura]','$_POST[totalcxc]','$_POST[valor_pagado]','$_POST[saldo2]','$_POST[observaciones]','Activo','$_POST[ids_fac_cp]')");
            pg_query("insert into pagos_cobrar values('$cont1','$_POST[id_cliente]','$_SESSION[id]','" . $cont[0] . "','$_POST[fecha_actual]','$_POST[hora_actual]','$_POST[forma_pago]','$_POST[tipo_pago]','$_POST[num_factura]','FACTURA','$_POST[fecha_factura]','$_POST[totalcxc]','$_POST[valor_pagado]','$_POST[saldo2]','$_POST[observaciones]','Activo',$conpuntoresult, '')");
            ////////////////////////////////////////
            //
            ////////////modificar pagos////////
        ...
        for ($i = 1; $i < $nelem; $i++) {
            ...
            $cont1++;
            ////////////guardar pagos////////
            //        	 echo '<br>GUARDAR FACTURA VENTA: <br>' . "insert into pagos_cobrar values('$cont1','$_POST[id_cliente]','$_SESSION[id]','$contComprobante','$_POST[fecha_actual]','$_POST[hora_actual]','$_POST[forma_pago]','$_POST[tipo_pago]','$arreglo2[$i]','$arreglo3[$i]','$arreglo4[$i]','$arreglo5[$i]','$arreglo6[$i]','$arreglo7[$i]','$_POST[observaciones]','Activo',$conpuntoresult)";//////////////////////////
            //	 
