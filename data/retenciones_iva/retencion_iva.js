...
//    }).trigger('resize');
    jQuery("#list1").jqGrid({
        ...
        colModel: [
            ...
            {name: 'descripcion_r', index: 'descripcion_r', editable: true, align: 'center', width: '200', search: true, frozen: true, formoptions: {elmsuffix: " (*)"}, editrules: {required: true}},
            ...
            {name: 'cuenta_debito', index: 'cuenta_debito', editable: true, align: 'center', width: '400', search: true, frozen: true, formoptions: {elmsuffix: " (*)"}, editrules: {required: true}, edittype: 'select', editoptions:{dataUrl: 'retornar_plan_cuentas.php'}},
            {name: 'cuenta_credito', index: 'cuenta_credito', editable: true, align: 'center', width: '400', search: true, frozen: true, formoptions: {elmsuffix: " (*)"}, editrules: {required: true}, edittype: 'select', editoptions:{dataUrl: 'retornar_plan_cuentas.php'}}
        ],
        rowNum: 20,
        rowList: [20],
        height: 300,
...
//    }).trigger('resize');
    jQuery("#list").jqGrid({
        ...
        colModel: [
            ...
            {name: 'cuenta_debito', index: 'cuenta_debito', editable: true, align: 'left', width: '400', search: true, frozen: true, formoptions: {elmsuffix: " (*)"}, editrules: {required: true}, edittype: 'select', editoptions:{dataUrl: 'retornar_plan_cuentas.php'}},
            {name: 'cuenta_credito', index: 'cuenta_credito', editable: true, align: 'left', width: '400', search: true, frozen: true, formoptions: {elmsuffix: " (*)"}, editrules: {required: true}, edittype: 'select', editoptions:{dataUrl: 'retornar_plan_cuentas.php'}}
        ],
        rowNum: 20,
        rowList: [ 20],
        height: 300,
