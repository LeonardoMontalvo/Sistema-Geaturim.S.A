...
<body class="skin-blue">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#tab_contrato" data-toggle="tab">Flete</a></li>
                                <li><a href="#tab_operacion" data-toggle="tab">Gastos y Abonos</a></li>
                            </ul>
                                            ...
                                            <div class="row">
                                                <div class="col-md-1">
                                                    <div class="form-group">
                                                        <label for="nro_viaje">Viaje</label>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <input id="nro_contrato" name="nro_viaje" type="number" disabled class="form-control" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="panel panel-default">
                                                        ...
                                                        <div class="panel-body">
                                                            <div class="col-md-6">
                                                                <div class="form-group required">
                                                                    <label for="valor">Valor flete:</label>
                                                                    <div class="input-group">
                                                                        <div class="input-group-addon">
                                                                            <b>$</b>
                                                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <form id="form_operacion">
                                                <div class="form-group required">
                                                    ...
                                                    <input name="accion" type="radio" value="i" required> DINERO ENTREGADO / INGRESO <br>
                                                    <input name="accion" type="radio" value="e"> GASTO / EGRESO <br>
                                                    <!-- <input name="accion" type="radio" value="a"> ABONO <br> -->
                                                </div>
                                                <div class="form-group required">
                                                    <label>Valor:</label>
                                                    <input id="valor_o" name="valor_o" type="number" class="form-control" step="0.01" min="0.01" required>
                                                </div>
                                                <div class="form-group required">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="nro_documento" name="nro_documento" class="form-control" type="text">
                                                </div>
                                                <div class="form-group required">
                                                    <label>Descripción de operación</label>
                                                    <input id="descripcion" name="descripcion" type="text" style="text-transform: uppercase" class="form-control" required>
                                                </div>
                                        ...
                                        <div class="col-md-8" id="div_tabla_o">
                                            ...
                                            <table class="table" style="width: 100%;">
                                                <tr>
                                                    <td>DINERO ENTREGADO: <span id="total_ingresos"></span></td>
                                                    <td>VALOR FLETE: <span id="total_contrato"></span></td>
                                                </tr>
                                                <tr>
                                                    <td style="border-bottom: #000 1px solid">TOTAL GASTOS: <span id="total_egresos"></span></td>
                                                    <td style="border-bottom: #000 1px solid"><b>TOTAL: <span id="total_cancelacion"></span></b></td>
                                                </tr>
                                                <!-- <tr>
    ...
    <div id="contratos" title="Búsqueda de Fletes" class="">
    ...
    <script src="contrato.js" type="text/javascript"></script>
