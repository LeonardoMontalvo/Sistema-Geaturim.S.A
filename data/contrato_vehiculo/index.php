...
<html>
    ...
    <body class="skin-blue">
        ...
        <div id="tipo_vehiculo" title="AGREGAR TIPO DE VEHÍCULO">
            <form id="form_tv">
                ...
                <input type="submit" id="submit_form_tv" value="submit" hidden>
            </form>
            <button class="btn btn-primary" id='btnGuardarTV'>Guardar</button>
        </div>

        <div id="marca" title="AGREGAR MARCA DE VEHÍCULO">
            <form id="form_m">
                <div class="form-group required">
                    <div class="control-group">
                ...
                <input type="submit" id="submit_form_m" value="submit" hidden>
            </form>
        ...
        <script src="vehiculo.js" type="text/javascript"></script>
