...
if ($data != 2) {
    $cont1_gastos = 0;
    $consulta_gastos = pg_query("select * from gastos where id_gastos ='$_POST[id_factura]'");
    while ($row = pg_fetch_row($consulta_gastos)) {
        $cont1_gastos = $row[16];
    }
...
//	
            ...
            $contre++;
    pg_query("insert into retencion_fuente_factura_compra values('" . $cont1 . "', '$_POST[id_factura]', '$_POST[id_retencion_fuente]','$_POST[fecha_actual]','" . $hora . "','$_POST[valor_factura]','$_POST[iva_factura]','$_POST[valor_retencion]', '$_POST[autorizacion_ret]','$_POST[serie_sinretencion]','g' ,'10','g','2')");
