...
$(document).keydown(function (e) {
    ...
    if (e.target.id == "calculoRetencionF"
            || e.target.id == "calculoRetencionFS"
            || e.target.id == "calculoRetencionI"
            || e.target.id == "calculoRetencionIs") {
        return;
    }
...
function obtenerParametrosEmpresa() {
    fetch("obtener_parametros_empresa.php")
            ...
            .then(function (json) {
                ...
                formatoRC = json["formato_imperesion_retencion_gasto"];
            ...
            if ($("#valor").val() == "") {
                ...
                if (filas.length == 0) {
                    ...
                    var datarow = {
                        ...
                        iva: calculoIVA > 0 ? "Si" : "No", //$("#tipo_iva").val(),
                        centro_costo: $("#centro_costo").val(),
                        valor: precio,
                        bien_servicio: $("#bien_servicio").val(),
                        valor_iva: calcularIva(Number(precio)),
                        tarifa: calculoIVA,
                ...
                $("#valor_factura").val(total.toFixed(2));
                $("#valor_formas").val(total.toFixed(2));
                $("#codigo_barras").focus();
                $("#tipo_iva")[0].options[0].selected = true;
            }
        }
    }
                ...
                if (repe == 1 && $("#fecha_dias").val() == "") {
                    ...
                    $.ajax({
                        ...
                        data: "id_factura_venta=" + $("#id_factura_venta").val() +
                                ...
                                "&formaspago_mixto=" + $("#formaspago_mixto").val() +
                        ...
                        success: function (data) {
                            ...
                            if (val == 1) {
                                if (check_retenciones == 1) {
                                    alertify.confirm("¿Desea ingresar retenciones?", function (e) {
                                        if (e) {
                                            $("#tipoRetencionesF").attr("disabled", false);
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            /*CAMBIOIVA*/if (val != 1) {
                calculoIVA = val;
                if ($("#fecha_emision").val()) {
                    if (new Date($("#fecha_emision").val()) < new Date('2024-04-01')) {
                        calculoIVA = 12;
                    }
                }
            }
    ...
    $("#btnImprimir").click(function () {
        $.ajax({
            ...
            success: function (data) {
                ...
                console.log(val);
                if (val != "") {
                    window.open(formatoRC + "?hoja=A4&id=" + $("#comprobante_serie").val(), '_blank');
    ...
    jQuery("#list").jqGrid({
        ...
        delOptions: {
            ...
            onclickSubmit: function (rp_ge, rowid) {
                ...
                $("#valor_formas").val(total_total.toFixed(2));
        ...
        afterSaveCell: function (rowid, name, val, iRow, iCol) {
            ...
            if (name == 'valor') {
                ...
                if (ret.iva === "Si") {
                    ...
                    $("#valor_formas").val(t_fc.toFixed(2));
                } else {
                                                ...
                                                if ($("#tot").val() > 500.000) {
                                                        ...
                                                        $.ajax({
                                                            ...
                                                            success: function (data) {
                                                                ...
                                                                if (val != 0) {
                                                                    ...
                                                                    console.log("hola chec retencion");
                                                                    if (check_retenciones == 1) {
                                                    ...
                                                    $.ajax({
                                                        ...
                                                        success: function (data) {
                                                            ...
                                                            if (val != 0) {
                                                                alertify.alert("Gasto Guardado correctamente");
                                                                console.log("hola check_retencion");
...
function calcularTotalesTablaProductos() {
    ...
    rows.forEach(el => {
        ...
        valiva[el.tarifa].subtotal += Number(el.valor);
    });
...
async function cargarFacturaDblclick(id) {
    if (id) {
        ...
        await $.getJSON('buscar_gastos2.php?com=' + valor, function (data) {
            ...
            if (tama != 0) {
                for (var i = 0; i < tama; i = i + 12) {
                    ...
                    var datarow = {
                        ...
                        valor_iva: data[i + 7],
                        tarifa: data[i + 8],
                        cod_impuesto: data[i + 9],
                        cod_tarifa: data[i + 10],
        ...
        await $.getJSON('buscar_gastos.php?com=' + valor, function (data) {
            var tama = data.length;
            t = data[23];
            if (tama !== 0) {
