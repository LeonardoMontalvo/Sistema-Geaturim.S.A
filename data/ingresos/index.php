...
<body class="skin-blue">
    <div class="wrapper">
            ...
            <section class="content">
                <div class="row">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a data-toggle="tab" href="#transferencias">TRANSFERENCIAS PENDIENTES</a></li>
                        <li><a data-toggle="tab" href="#transferencias_h">HISTORIA DE TRANSFERENCIAS</a></li>
                    </ul>
                </div>
                                        ...
                                        <div class="rows">
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            <div class="input-group">
                                                                                <select class="form-control" name="origen" id="origen">
                                                                                    ...
                                                                                    <?php
                                                                                    /* $consulta = pg_query("select * from punto_venta   order by id_punto_venta  ");
                                                                                          while ($row = pg_fetch_row($consulta)) {
                                            ...
                                            <div class="row">
                                                <div class="col-mx-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group col-md-7 no-padding">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="total_p" id="total_p" value="0.0000" readonly class="form-control" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group col-md-7 no-padding">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="total_p2" id="total_p2" value="0.0000" readonly class="form-control" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <input type="hidden" name="iva" id="iva" value="0.0000" readonly class="form-control" />
                                                    <!--                                                                        </div>
                                                                                                                                        </div>
                                                                                                                                    </div>-->
                                                    ...
                                                    <input type="hidden" name="desc" id="desc" value="0.0000" readonly class="form-control" />
                                                    <!--                                                                        </div>
                                                                                                                                        </div>
                                                                                                                                    </div>-->
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group col-md-7 no-padding">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" name="tot" id="tot" value="0.0000" readonly class="form-control" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <div id="transferencias_h" class="tab-pane fade">
            <div class="row">
                <div class="col-md-12">
    ...
    <script src="transferencias/transferencias.js" type="text/javascript"></script>
</body>
