...
b.nombre_punto destino,
bo.nombre_punto origen
...
on b.id_punto_venta=tb.id_bodega_destino
left join punto_venta bo
on bo.id_punto_venta=tb.id_bodega_origen
...
while ($row = pg_fetch_assoc($result)) {
    ...
    $s .= "<cell>" . $row['estado_transferencia'] . "</cell>";
    $s .= "<cell>" . $row['usuario_origen'] . "</cell>";
    $s .= "<cell>" . $row['origen'] . "</cell>";
    $s .= "<cell>" . $row['destino'] . "</cell>";
    $s .= "<cell>" . $row['usuario_destino'] . "</cell>";
    $s .= "<cell>" . $row['fecha_modificacion'] . "</cell>";
    $s .= "</row>";
}
$s .= "</rows>";
echo $s;
