...
if ($_POST["tipo_venta"] == "FACTURA") {
    ...
    if ($forma == "Credito") {
        ...
        for ($i = 0; $i <= $nelem; $i++) {
            ...
            pg_query("insert into kardex_valorizado values(".$cont_v.",'".$arreglo1[$i]."','$_POST[fecha_actual]', '" . 'Venta: '. $_POST['num_factura']."','','".$cantidad_salida."','".$cantidad."','".$precio_unitario_salida."','".$precio_total_salida."','','','".$cantidad_total."','4')");
            // fin

            // guardar kardex
            pg_query("insert into kardex values('$cont_k','$_POST[fecha_actual]', '" . 'F.V:' . $_POST['num_factura'] . "' ,'$arreglo2[$i]','$arreglo3[$i]','$arreglo5[$i]','$arreglo1[$i]','$cal','2','','')");
            // 
        }
        ...
        if ($forma == "Contado") {
            for ($i = 0; $i <= $nelem; $i++) {
                ...
                pg_query("insert into detalle_liquidacion_compra values('$cont6','$cont1','$arreglo1[$i]','$arreglo2[$i]','$arreglo3[$i]','$arreglo4[$i]','$arreglo5[$i]','Activo','$arreglo6[$i]')");
                // fin
