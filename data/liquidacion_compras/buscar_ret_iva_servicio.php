...
$consulta = pg_query("select SUM(total_compra::FLOAT) from detalle_factura_compra,productos where  detalle_factura_compra.cod_productos=productos.cod_productos and id_factura_compra ='$_POST[id]'  and productos.iva='Si'");
