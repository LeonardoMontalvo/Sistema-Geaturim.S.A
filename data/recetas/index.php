...
$cont1 = 0;
$consulta2 = pg_query("select max(id_receta) from recetas");
...
<html>
  ...
  <body class="skin-blue">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="box box-primary">
                <div class="box-body">
                  <div class="row">
                    <form id="productos_form" name="productos_form" method="post">
                              ...
                              <div class="col-md-3">
                                <div class="form-group">
                                  ...
                                  <div class="input-group">
                                    ...
                                    <input type="hidden" name="id_receta"  id="id_receta" readonly class="form-control"/>
                        ...
                        <h3 class="box-title" style="margin-left: 15px">Detalle Receta</h3>
                                ...
                                <select class="form-control" name="unidad" id="unidad">
                                  <?php
                                    ...
                                    while ($row = pg_fetch_row($consulta)) {
                                        echo "<option id=$row[0] value=$row[0]"."-"."$row[1]".">$row[1]</option>";
                                    }
                                  ?>     
                                </select>
                ...
                <div id="buscar_recetas" title="BUSCAR RECETAS">
    ...
    <script src="recetas.js" type="text/javascript"></script>
