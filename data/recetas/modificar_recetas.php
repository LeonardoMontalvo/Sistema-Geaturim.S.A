...
$repe=0;
$consulta = pg_query("select * from recetas where id_receta <> '$_POST[id_receta]' and nombre='" . strtoupper($_POST['nombre']) . "'");
...
if($repe==0){
    ...
    pg_query("Update recetas set id_usuario = '$_SESSION[id]', fecha_modificacion = '$_POST[fecha_actual]',  costo_producto = '$_POST[costo]', cod_productos='$_POST[producto]', nombre='$_POST[nombre]' where id_receta = '$_POST[id_receta]'");
    // fin
