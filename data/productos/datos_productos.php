...
while ($row = pg_fetch_assoc($result)) {
    ...
    $s .= "<cell>" . $row['articulo'] . "</cell>"; //articulo
    ...
    $s .= "<cell>" . $row['nombre_generico'] . "</cell>"; //nombre_generico
    $s .= "<cell>" . $row['nombre_categoria'] . "</cell>"; //nombre_categoria
    ...
    $s .= "<cell>" . $row['nombre_marca'] . "</cell>"; //nombre_marca
    ...
    $s .= "<cell>" . $row['descripcion'] . "  -  " . $row['id_plan_cuentas'] . "</cell>"; //descripcion plan de cuenta - id_plan_cuentas
