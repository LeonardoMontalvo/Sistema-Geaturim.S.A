...
//       id_plan_cuentas, proveedor, cantidad_descuento
//       , bien_servicios
...
////  FROM syswebfe_inven_ant.productos where estado='Activo' order by cod_productos;";
////echo '//nivel12';
//$conexion_ori = conectarse_ori();
...
//   $sql="insert into productos values('". obtenerId_id() . "','$rowDPB[codigo]','$rowDPB[cod_barras]','$rowDPB[articulo]','$rowDPB[iva]','$rowDPB[series]','$rowDPB[precio_compra]'," . ($rowDPB[utilidad_minorista] == NULL ? "0.0000" : $rowDPB[utilidad_minorista]) . "," . ($rowDPB[utilidad_mayorista] == NULL ? "0.0000" : $rowDPB[utilidad_mayorista]) . ",'$rowDPB[iva_minorista]','$rowDPB[iva_mayorista]','1','1','$rowDPB[stock]','$rowDPB[stock_minimo]','$rowDPB[stock_maximo]','$rowDPB[fecha_creacion]','1','1','0','$rowDPB[estado]','$rowDPB[inventariable]'," . ($rowDPB[existencia] == NULL ? "0.00" : $rowDPB[existencia]) . "," . ($rowDPB[diferencia] == NULL ? "0.00" : $rowDPB[diferencia]) . ",'$rowDPB[imagen]','$rowDPB[id_bodega]','$rowDPB[incluye_iva]'," . ($rowDPB[iva_negocio] == NULL ? "0.0000" : $rowDPB[iva_negocio]) . ",'$rowDPB[id_plan_cuentas]','$rowDPB[proveedor]','0','0.0000','1','$id_timpu','$id_taimpuesto','$rowDPB[bien_servicios]','0','0','0','0')";        
