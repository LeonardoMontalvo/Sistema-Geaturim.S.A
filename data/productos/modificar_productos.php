...
if ($nombre == "") {
    $update = actualizarProductos($_POST['cod_productos'], $_POST['cod_prod'], mb_strtoupper($_POST['cod_barras']), $_POST['nombre_art'], obtenerValorIva($_POST['iva']), $_POST['series'], 
            ...
            $_POST['cantidad_descuento'], $_POST['utilidad_negocio'], $_SESSION['id'], $_POST['iva'], obtenerValorTarifa($_POST['tarifa']), $_POST['bien_servicio'], $_POST['cantidad_mayorista'], $_POST['cantidad_negocio'], $_POST['codigo_auxiliar']);
} else {
    ...
    $update = actualizarProductos($_POST['cod_productos'], $_POST['cod_prod'], mb_strtoupper($_POST['cod_barras']), $_POST['nombre_art'], obtenerValorIva($_POST['iva']), $_POST['series'], 
            ...
            $_POST['cantidad_descuento'], $_POST['utilidad_negocio'], $_SESSION['id'], $_POST['iva'], obtenerValorTarifa($_POST['tarifa']), $tarifavalor, $_POST['bien_servicio'], $_POST['codigo_auxiliar']);
}
...
function actualizarProductos($producto, $codigo, $barras, $articulo, $iva, $series, $precioCompra, $utiliMinorista, $utilMayorista, $ivaMinorista, $ivaMayorista, $id_categoria, 
        ...
        $incluyeIva, $ivaNegocio, $id_plan_cuentas, $id_proveedor, $cantidad_descuento, $utilidad_negocio, $id_usuario, $id_timpu, $id_taimpuesto, $bien_servicios,$cantidad_mayorista,$cantidad_negocio, $codigo_auxiliar) {
    ...
    $update = "UPDATE productos SET codigo = '$codigo', cod_barras = '$barras', articulo = '$articulo', iva = '$iva', series = '$series', "
            ...
            . "id_timpu = " . ($id_timpu == NULL ? "NULL" : $id_timpu) . ", id_taimpuesto = " . ($id_taimpuesto == NULL ? "NULL" : $id_taimpuesto) . ", bien_servicios = '$bien_servicios', cantidad_mayorista = '$cantidad_mayorista', cantidad_negocio = '$cantidad_negocio', codigo_auxiliar = '$codigo_auxiliar' "
