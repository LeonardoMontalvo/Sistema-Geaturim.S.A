...
if ($_POST["tipo_venta"] == "FACTURA") {
    ...
    foreach (obtenerDetallaVenta($_POST['comprobante'], $conpuntoresult) as $item) {
        ...
        procesarKardexEntrada($item['cod_productos'], $documento, $item['cantidad'], $stock, $costoPromedio, 'Activo', $conpuntoresult, 'AV', $_POST['comprobante'], $total, NULL, NULL, '', NULL, NULL, $item['id_cliente'], $_SESSION['id']);
    }
} else {
    if ($_POST["tipo_venta"] == "NOTA") {
        ...
        foreach (obtenerDetallaNota($_POST['comprobante'], $conpuntoresult) as $item) {
            ...
            procesarKardexEntrada($item['cod_productos'], $documento, $item['cantidad'], $stock, $costoPromedio, 'Activo', $conpuntoresult, 'ANV', $_POST['comprobante'], $total, NULL, NULL, '', NULL, NULL, $item['id_cliente'], $_SESSION['id']);
        }
    }
}
$data = 1;
