...
$consulta1 = pg_query("SELECT * FROM productos p LEFT JOIN detalle_producto_bodega dpb ON p.cod_productos=dpb.cod_productos where articulo ilike '%$producto_nombre%' AND dpb.id_bodega=$conpuntoresult  ");
