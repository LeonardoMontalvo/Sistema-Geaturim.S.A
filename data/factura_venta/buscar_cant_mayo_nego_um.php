...
$consulta = pg_query("
SELECT productos.cod_productos,pvpmayo_cantidad,pvpnego_cantidad,unidad_medida_productos.id_unidades
...
and productos.cod_productos='$_POST[id_prod]' and unidad_medida_productos.id_unidades='$_POST[unidad_medida]' order by cantidad asc");
