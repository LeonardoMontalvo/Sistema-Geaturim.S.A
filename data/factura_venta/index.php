                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" name="digitador"  id="digitador" readonly 
                                                                           class="form-control" />
                                                            ...
                                                            <!--                                                            <label>Vendedor: </label>
                                                                                                                        <div class="input-group">
                                                                                                                            <select class="form-control" name="vendedor" id="vendedor">
                                                                                                                                <option   value="<?php //echo $campo_nombre_vendedor;                                               ?>" >Vendedor1 </option>
                                                                                                                                 <option   value="<?php //echo $campo_nombre_vendedor;                                               ?>" >VENDEDOR1 </option> 
                                                            <?php
...
<!--                                                            <input type="hidden" name="retencionFSguia" id="retencionF1Sguia" checked value="1"><span></span> </span><br/>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label class="col-md-3">Ced/RUC: <font color="red">*</font></label>
                                                                    <div class="form-group col-md-4 no-padding">
...
<!--                                                            <input type="hidden" name="formaspago"  id="formaspago" value="Contado" placeholder="Buscar..." class="form-control" />-->
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-1">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" name="descxa" id="descxa"
                                                            ...
                                                            <div class="col-md-1">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input style="width:80px;height:30px;"  type="number" name="descxax" id="descxax"
                                                                           readonly="" value="0"
                                                                           class="form-control" />
                                                                </div>
                                                            </div>
                                                            ...
                                                            <input type="hidden" name="descx" id="descx" value="0.000"
                                                                   readonly class="form-control" />
                                                            <input type="hidden" name="desc" id="desc" value="0.000"
                                                                   readonly class="form-control" />
                                                            <!--                                                                        </div>
                                                                                                                                    </div>
                                                                                                                                </div>-->
            ...
            <!--                                                    <button class="btn bg-olive margin" id='btnModificar'><i class="fa fa-edit"></i> Modificar</button>-->
                        ...
                        <div id="cuentas_reten" title="Búsqueda Plan de Cuentas" class="">
                            <table id="list44_reten"><tr><td></td></tr></table>
                        ...
                        <div id="buscar_estadosguia" title="BUSCAR ESTADOS GUÍA REMISIÓN">
                            <table id="list77"><tr><td></td></tr></table>
                            <div id="pager77"></div>
                        </div>

                        <div id="productos" title="Búsqueda de Productos" class="">
                            <table id="listp"><tr><td></td></tr></table>
                            <div id="pagerp"></div>
                        </div>
