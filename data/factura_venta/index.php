    ...
    <body class="skin-blue">
        ...
        <div class="wrapper">
            ...
            ?>" >VENDEDOR1 </option> 
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                <label class="col-md-3">F.P.Electrónico</label>
                                                                <div class="form-group col-md-9 no-padding">
                                                                    <select class="form-group col-md-9 no-padding" name="formas" id="formas">
                                                            ...
                                                            <div class="col-md-2">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <span class="input-group-addon"><span style="font-size: 16px;"><b>%</b></span></span>
                                                                    </div>
