...
//        echo 'CHEQUE' . "insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ":" . "$p[1]" . ", COMPROBANTE: CHEQUE:" . "" . "$_POST[cheque_tarjeta]" . " " . "$_POST[bancos]', '$_POST[total_nominat]', '$_POST[total_nominat]', '0.000','1','" . ($res[0] + 1) . "','Activo' ,'$arreglo1[$i]','','','','','RP','','$conpuntoresult' ,'$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "')";
            $asiento = pg_query("insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ":" . "$p[1]" . ", COMPROBANTE: CHEQUE:" . "" . "$_POST[cheque_tarjeta]" . " " . "$_POST[bancos]', '$_POST[total_nominat]', '$_POST[total_nominat]', '0.000','1','" . ($res[0] + 1) . "','Activo' ,'$arreglo1[$i]','','','','','RP','','$conpuntoresult' ,'$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "')");
        } else if ($_POST['forma_pago'] == "CXP") {
//        echo 'CXP' . "insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: TARJETA:" . "', '$_POST[total_nominat]', '$_POST[total_nominat]', '0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "' )";
            $asiento = pg_query("insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: TARJETA:" . "', '$_POST[total_nominat]', '$_POST[total_nominat]', '0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "' )");
        } else if ($_POST['forma_pago'] == "CONTADO") {
//        echo 'CONTADO' . "insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: CONTADO', '$_POST[total_nominat]', '$_POST[total_nominat]', '0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "' )";
            $asiento = pg_query("insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: CONTADO', '$_POST[total_nominat]', '$_POST[total_nominat]', '0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "' )");
        } else if ($_POST['forma_pago'] == "TRANSFERENCIA") {
//        echo 'TRANSFERENCIA1' . "insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: TRANSFERENCIA:" . "" . "$_POST[cheque_tarjeta]" . " " . "$_POST[bancos]', '$_POST[total_nominat]', '$_POST[total_nominat]','0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "')";
            $asiento = pg_query("insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: TRANSFERENCIA:" . "" . "$_POST[cheque_tarjeta]" . " " . "$_POST[bancos]', '$_POST[total_nominat]', '$_POST[total_nominat]','0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "')");
        }
        //////////////////////////////
...
//    echo '<br>DETALLE TRANSACCION NETO RECIBIR HABER: <br>' . "insert into detalle_transaccion values('" . $fila1[0] . "','" . $fila[0] . "','" . $forma . "','0.000','$arreglo19[$i]','Activo')"; //////////////////////////
        ...
        $result_suma_tercer_cuarto_seul=$_POST["tercer_sueldot"]+$_POST["cuarto_sueldot"];
        
        echo '///'.$result_suma_tercer_cuarto_seul;
        //SECUENCIAL AL GUARDAR POR MODULO
        if ($_POST['forma_pago'] == "CHEQUE") {
//        echo 'CHEQUE' . "insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ":" . "$p[1]" . ", COMPROBANTE: CHEQUE:" . "" . "$_POST[cheque_tarjeta]" . " " . "$_POST[bancos]', '$result_suma_tercer_cuarto_seul', '$result_suma_tercer_cuarto_seul', '0.000','1','" . ($res[0] + 1) . "','Activo' ,'$arreglo1[$i]','','','','','RP','','$conpuntoresult' ,'$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "')";
            $asiento = pg_query("insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ":" . "$p[1]" . ", COMPROBANTE: CHEQUE:" . "" . "$_POST[cheque_tarjeta]" . " " . "$_POST[bancos]', '$result_suma_tercer_cuarto_seul', '$result_suma_tercer_cuarto_seul', '0.000','1','" . ($res[0] + 1) . "','Activo' ,'$arreglo1[$i]','','','','','RP','','$conpuntoresult' ,'$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "')");
        } else if ($_POST['forma_pago'] == "CXP") {
//        echo 'CXP' . "insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: TARJETA:" . "', '$result_suma_tercer_cuarto_seul', '$result_suma_tercer_cuarto_seul', '0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "' )";
            $asiento = pg_query("insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: TARJETA:" . "', '$result_suma_tercer_cuarto_seul', '$result_suma_tercer_cuarto_seul', '0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "' )");
        } else if ($_POST['forma_pago'] == "CONTADO") {
//        echo 'CONTADO' . "insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: CONTADO', '$result_suma_tercer_cuarto_seul', '$result_suma_tercer_cuarto_seul', '0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "' )";
            $asiento = pg_query("insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: CONTADO', '$result_suma_tercer_cuarto_seul', 'v', '0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "' )");
        } else if ($_POST['forma_pago'] == "TRANSFERENCIA") {
//        echo 'TRANSFERENCIA2' . "insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: TRANSFERENCIA:" . "" . "$_POST[cheque_tarjeta]" . " " . "$_POST[bancos]', '$result_suma_tercer_cuarto_seul', '$result_suma_tercer_cuarto_seul','0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "')";
            $asiento = pg_query("insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: TRANSFERENCIA:" . "" . "$_POST[cheque_tarjeta]" . " " . "$_POST[bancos]', '$result_suma_tercer_cuarto_seul', '$result_suma_tercer_cuarto_seul','0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "')");
        }
...
//        echo '<br>DETALLE TRANSACCION CREDITO HABER: <br>' . "insert into detalle_transaccion values('" . $fila1[0] . "','" . $fila[0] . "','" . $buscaCuenta[0] . "','$arreglo9[$i]','0.000','Activo')"; //////////////////////////
        ...
        if ($_POST['forma_pago'] == "CHEQUE") {
//        echo 'CHEQUE' . "insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ":" . "$p[1]" . ", COMPROBANTE: CHEQUE:" . "" . "$_POST[cheque_tarjeta]" . " " . "$_POST[bancos]', '$_POST[aporte_patronalt]', '$_POST[aporte_patronalt]', '0.000','1','" . ($res[0] + 1) . "','Activo' ,'$arreglo1[$i]','','','','','RP','','$conpuntoresult' ,'$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "')";
            $asiento = pg_query("insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ":" . "$p[1]" . ", COMPROBANTE: CHEQUE:" . "" . "$_POST[cheque_tarjeta]" . " " . "$_POST[bancos]', '$_POST[aporte_patronalt]', '$_POST[aporte_patronalt]', '0.000','1','" . ($res[0] + 1) . "','Activo' ,'$arreglo1[$i]','','','','','RP','','$conpuntoresult' ,'$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "')");
        } else if ($_POST['forma_pago'] == "CXP") {
//        echo 'CXP' . "insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: TARJETA:" . "', '$_POST[aporte_patronalt]', '$_POST[aporte_patronalt]', '0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "' )";
            $asiento = pg_query("insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: TARJETA:" . "', '$_POST[aporte_patronalt]', '$_POST[aporte_patronalt]', '0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "' )");
        } else if ($_POST['forma_pago'] == "CONTADO") {
//        echo 'CONTADO' . "insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: CONTADO', '$_POST[aporte_patronalt]', '$_POST[aporte_patronalt]', '0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "' )";
            $asiento = pg_query("insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: CONTADO', '$_POST[aporte_patronalt]', '$_POST[aporte_patronalt]', '0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "' )");
        } else if ($_POST['forma_pago'] == "TRANSFERENCIA") {
//        echo 'TRANSFERENCIA3' . "insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: TRANSFERENCIA:" . "" . "$_POST[cheque_tarjeta]" . " " . "$_POST[bancos]', '$_POST[aporte_patronalt]', '$_POST[aporte_patronalt]','0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "')";
            $asiento = pg_query("insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: TRANSFERENCIA:" . "" . "$_POST[cheque_tarjeta]" . " " . "$_POST[bancos]', '$_POST[aporte_patronalt]', '$_POST[aporte_patronalt]','0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "')");
        }
...
//        echo '<br>DETALLE TRANSACCION CREDITO H: <br>' . "insert into detalle_transaccion values('" . $fila1[0] . "','" . $fila[0] . "','" . $buscaCuenta[0] . "','0.000','$arreglo7[$i]','Activo')"; //////////////////////////
        ...
        if ($_POST['fondos_acu_mensual'] == "fondos_acumulado") {
            ...
            if ($_POST['forma_pago'] == "CHEQUE") {
//        echo 'CHEQUE' . "insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ":" . "$p[1]" . ", COMPROBANTE: CHEQUE:" . "" . "$_POST[cheque_tarjeta]" . " " . "$_POST[bancos]', '$_POST[fondos_recervat]', '$_POST[fondos_recervat]', '0.000','1','" . ($res[0] + 1) . "','Activo' ,'$arreglo1[$i]','','','','','RP','','$conpuntoresult' ,'$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "')";
                $asiento = pg_query("insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ":" . "$p[1]" . ", COMPROBANTE: CHEQUE:" . "" . "$_POST[cheque_tarjeta]" . " " . "$_POST[bancos]', '$_POST[fondos_recervat]', '$_POST[fondos_recervat]', '0.000','1','" . ($res[0] + 1) . "','Activo' ,'$arreglo1[$i]','','','','','RP','','$conpuntoresult' ,'$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "')");
            } else if ($_POST['forma_pago'] == "CXP") {
//        echo 'CXP' . "insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: TARJETA:" . "', '$_POST[fondos_recervat]', '$_POST[fondos_recervat]', '0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "' )";
                $asiento = pg_query("insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: TARJETA:" . "', '$_POST[fondos_recervat]', '$_POST[fondos_recervat]', '0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "' )");
            } else if ($_POST['forma_pago'] == "CONTADO") {
//        echo 'CONTADO' . "insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: CONTADO', '$_POST[fondos_recervat]', '$_POST[fondos_recervat]', '0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "' )";
                $asiento = pg_query("insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: CONTADO', '$_POST[fondos_recervat]', '$_POST[fondos_recervat]', '0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "' )");
            } else if ($_POST['forma_pago'] == "TRANSFERENCIA") {
//        echo 'TRANSFERENCIA4' . "insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: TRANSFERENCIA:" . "" . "$_POST[cheque_tarjeta]" . " " . "$_POST[bancos]', '$_POST[fondos_recervat]', '$_POST[fondos_recervat]','0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "')";
                $asiento = pg_query("insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: TRANSFERENCIA:" . "" . "$_POST[cheque_tarjeta]" . " " . "$_POST[bancos]', '$_POST[fondos_recervat]', '$_POST[fondos_recervat]','0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "')");
            }
...
//        echo 'CXP m' . "insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: TARJETA:" . "', '$_POST[total_nominat]', '$_POST[total_nominat]', '0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "' )";
            $asiento = pg_query("insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: TARJETA:" . "', '$_POST[total_nominat]', '$_POST[total_nominat]', '0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "' )");
        } else if ($_POST['forma_pago'] == "CONTADO") {
//            echo 'CONTADO m' . "insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: CONTADO', '$_POST[total_nominat]', '$_POST[total_nominat]', '0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "' )";
            $asiento = pg_query("insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: CONTADO', '$_POST[total_nominat]', '$_POST[total_nominat]', '0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "' )");
        } else if ($_POST['forma_pago'] == "TRANSFERENCIA") {
//        echo 'TRANSFERENCIA 5' . "insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: TRANSFERENCIA:" . "" . "$_POST[cheque_tarjeta]" . " " . "$_POST[bancos]', '$_POST[total_nominat]', '$_POST[total_nominat]','0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "')";
            $asiento = pg_query("insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: TRANSFERENCIA:" . "" . "$_POST[cheque_tarjeta]" . " " . "$_POST[bancos]', '$_POST[total_nominat]', '$_POST[total_nominat]','0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "')");
        }
        //////////////////////////////
...
if($_POST[aporte_patronalt]!='0.0000'){   
...
//        echo 'TRANSFERENCIA6' . "insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: TRANSFERENCIA:" . "" . "$_POST[cheque_tarjeta]" . " " . "$_POST[bancos]', '$_POST[aporte_patronalt]', '$_POST[aporte_patronalt]','0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "')";
            $asiento = pg_query("insert into transacciones values('" . $fila[0] . "', '$_SESSION[id]', '" . $cont1 . "','$_POST[fecha_actual]','$_POST[hora_actual]', 'ROL DE PAGO, NOMINA: " . $p[0] . ", COMPROBANTE: TRANSFERENCIA:" . "" . "$_POST[cheque_tarjeta]" . " " . "$_POST[bancos]', '$_POST[aporte_patronalt]', '$_POST[aporte_patronalt]','0.000','1','" . ($res[0] + 1) . "','Activo','$arreglo1[$i]','','','','','RP','','$conpuntoresult','$_POST[fecha_actual]','" . ($res_pv[0] + 1) . "')");
        }
}
