...
//        alertify.error("SUELDO PERCIBIDO1: Ya tiene valor")
    ...
    function cargarSbu(){
           $.ajax({
                type: "POST",
               url: "../cargo/cargar_sbu.php",
                data: "" ,
                success: function (data) {
                    var val = data;
                  $("#sueldo_basico").val(val);
                }
            }); 
    }
    function limpiar_campo4() {
    if ($("#cedula_empleado").val() == "") {
        console.log("limpiesa");
        $("#nombres_empleado").val("");
        $("#fecha_ingreso").val("");
    ...
    function inicio() {
            $("#cedula_empleado").on("keyup", limpiar_campo4);
              $("#nombres_empleado").on("keyup", limpiar_campo5);
        cargarSbu();
  ...
  $("#nombres_empleado").keyup(function () {
            if ($("#select_mes").val() == "0") {
                alertify.error("DEBE SELECCIONAR EL MES");
                $("#select_mes").focus();
            }
