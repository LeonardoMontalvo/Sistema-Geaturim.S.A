...
$consulta = pg_query("select max(num_serie)  from guia_remision,  punto_venta_empresa where    
guia_remision.id_empresa=$campo_punto_ventaid  ");
...
$cont1 = 0;
$consulta2 = pg_query("select max(id_guia_remision) from guia_remision");
...
$consulta4 = pg_query("select max(id_guia_remision) from guia_remision");
while ($row = pg_fetch_row($consulta2)) {
    $cont1 = $row[0];
}
...
$consulta999 = pg_query("select direccion_empresa from empresa");
while ($row = pg_fetch_row($consulta999)) {
    $punto_partida = $row[0];
}
...
<html>
    ...
    <body class="skin-blue">
            ...
            <div class="content-wrapper">
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Guia Remisión</li>
                    </ol>
                </section>
                        ...
                        <div class="col-md-12">
                            <div class="box box-primary">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li><a href="#tab_2" data-toggle="tab" style="display: none">Adicionales</a></li>
                                    <li><a href="#tab_3" data-toggle="tab" style="display: none">Formas de Pago</a></li>
                                </ul>
                                <form id="productos_form" name="productos_form" method="post">
                                    <div class="box-body">
                                                    ...
                                                    <div class="row ">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-3">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        ...
                                                                        <input type="hidden" name="id_guia_remision" id="id_guia_remision" readonly class="form-control" />
                                                            ...
                                                            <div class="col-md-2">
                                                                ...
                                                                <input type="hidden" name="nombre_vendedor" id="nombre_vendedor" disabled="" required class="form-control" value="<?php echo "Vende.:" . "  " . $campo_vendedor ?>" />
                                                            ...
                                                            <div class="row" >
                                                                ...
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        <label class="col-md-4" id="translabel">Transportista: <font color="red">*</font></label>
                                                                        <div class="form-group col-md-8 p-0">
                                                                        ...
                                                                        <div class="form-group col-md-5 p-0">
                                                                            ...
                                                                            <span class="input-group-btn">
                                                                                ...
                                                                                <input type='button' class="btn btn-primary" id="trans" value='Transportista' onclick="window.open('../Transportista/index.php', 'width=800,height=600');" />
                                                                                 <button class="btn btn-primary" id='btnActualizartrans_g'>Actualizar Comprobante</button>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label class="col-md-5">Fecha Inicio Transporte: <font color="red">*</font></label>
                                                                    <div class="form-group col-md-7 p-0">
                                                                        <input type="date" name="fecha_ini_transporte" id="fecha_ini_transporte" required class="form-control" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label class="col-md-5">Fecha Fin Transporte: <font color="red">*</font></label>
                                                                    <div class="form-group col-md-7 p-0">
                                                                        <input type="date" name="fecha_fin_transporte" id="fecha_fin_transporte" required class="form-control" />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <label class="col-md-4">Punto Partida: <font color="red">*</font></label>
                                                                    <div class="form-group col-md-8 p-0">
                                                                        <input type="text" name="punto_partida" id="punto_partida"  class="form-control"  value="<?php echo $punto_partida ?>"/>
                                                            ...
                                                            <div class="row ">
                                                                <div class="col-md-12">
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            <label class="col-md-4">Destinatario: <font color="red">*</font></label>
                                                                            <div class="form-group col-md-8 p-0">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label class="col-md-4">Motivo Traslado: <font color="red">*</font></label>
                                                                            <div class="form-group col-md-8 p-0">

                                                                                <input type="text" name="tipo_motivo" id="tipo_motivo" style="text-transform: uppercase" placeholder="MOVILIZACIÓN DE MERCADERIA" value="MOVILIZACIÓN DE MERCADERIA" class="form-control" />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                       <div class="col-md-5">
                                                                        <div class="form-group">
                                                                            <label class="col-md-4">Destino(Punto llegada): <font color="red">*</font></label>
                                                                            <div class="form-group col-md-5 p-0">

                                                                                <input type="text" name="destino" id="destino" style="text-transform: uppercase"  class="form-control" />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <!--                                                                    <div class="col-md-3" style="display: none">
                                                                                                                                            <div class="form-group">
                                                                                                                                                ...
                                                                                                                                                <div class="form-group col-md-9 p-0">
                                                                                                                                                    <select class="form-group col-md-11 p-0" name="formas" id="formas">
                                                                                                            ...
                                                                                                            <div class="col-md-9">
                                                                                                                ...
                                                                                                                <div class="col-md-6">
                                                                                                                    <div class="form-group">
                                                                                                                        ...
                                                                                                                        <div class="form-group col-md-4 p-0">
                                                                                                                            <button class="btn btn-secondary" id="btnCuenta_reten" name="btnCuenta_reten" disabled="disabled">Seleccionar Cuenta</button>
                                                                                                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-mx-12">
                                                <p>
                                                    <button class="btn bg-olive margin" id='btnGuiaRemision' ><i class="fa fa-save"></i>Guardar</button>                                        
                                                    <button class="btn bg-olive margin" id='btnBuscar'><i class="fa fa-search"></i> Buscar</button>
                                                    <button class="btn bg-olive margin" id='btnNuevo'><i class="fa fa-pencil"></i> Nuevo</button>
                                                    <button class="btn bg-olive margin" id='btnAnular'><i class="fa fa-remove"></i> Anular</button>
                                                    <button class="btn bg-olive margin" id='btnImprimir' style="display:none"><i class="fa fa-print"></i> Imprimir</button>
                                                    <button class="btn bg-olive margin" id='btnProforma' style="display: none">Proformas</button>
                                                    ...
                                                    <button class="btn bg-olive margin" id='btnEstados' style="display:none"><i class="fa fa-check"></i> Estados Facturación</button>
                                                    ...
                                                    <button class="btn bg-olive margin" id='btnImprimirGuia' ><i class="fa fa-print"></i> Imprimir</button>
                                                    <button class="btn bg-olive margin" id='btnEstadosguia' ><i class="fa fa-check"></i> Estados Guia Remision</button>
        ...
        <script src="guia_remision.js" type="text/javascript"></script>
