...
$empresa = pg_query("SELECT dpb.stock,dpb.cod_productos,p.inventariable FROM productos p left join detalle_producto_bodega dpb on p.cod_productos=dpb.cod_productos  WHERE dpb.cod_productos=$producto AND dpb.id_bodega=$_SESSION[PV]");
