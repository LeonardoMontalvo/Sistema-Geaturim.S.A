...
function entrar() {
    ...
    if (expreg.test($("#cantidad").val())) {
        ...
        //        alertify.success("Debe estar un número antes del punto", "success", 1000,
        //                function () {
                    ...
                    if ($("#cantidad").val() == "") {
                        ...
                        if ($("#p_venta").val() == "") {
                            ...
                            if (parseFloat($("#precio").val()) <= parseFloat($("#p_venta").val())) {
                                ...
                                alertify.error("Error... el precio de compra es menor al de venta");
                            }
                        }
...
function buscar_bienservicio_producto() {
    console.log("id_factu " + $("#id_guia_remision").val());
    $.ajax({
        type: "POST",
        url: "buscar_bienservicio_producto.php",
        data: "id=" + $("#id_guia_remision").val(),
        success: function (data) {
            var valSUM = data;
                                ...
                                if (
                                    ...
                                    if (filas2.length == 0) {
                                        ...
                                        var datarow = {
                                            ...
                                            id_guia_remision: id_factura_nota,
...
function autocompletar_guia_num() {
    var temp = "";
    var serie = $("#num_oculto_guia").val();
    for (var i = serie.length; i < 9; i++) {
        temp = temp + "0";
    }
    return temp;
...
//                                                                                                        function (e) {
//                                                                                                            if (e) {
//                                                                                                                $("#id_guia_remision").val(data.id);
//                                                                                                                $("#id_guia_remision").trigger("change");
...
//                                    data: "id_guia_remision=" + $("#id_guia_remision").val() + "&id_cliente=" + $("#id_cliente").val() + "&comprobante=" + $("#comprobante").val() + "&num_factura=" + seriee + "&fecha_actual=" + $("#fecha_actual").val() + "&hora_actual=" + $("#hora_actual").val() + "&proforma=" + $("#proforma").val() + "&cancelacion=" + $("#cancelacion").val() + "&tipo_precio=" + $("#tipo_precio").val() + "&formas=" + $("#formas").val() + "&adelanto=" + $("#adelanto").val() + "&meses=" + $("#meses").val() + "&autorizacion=" + $("#autorizacion").val()+ "&fecha_auto=" + $("#fecha_auto").val()+ "&fecha_caducidad=" + $("#fecha_caducidad").val() + "&tarifa0=" + $("#total_p").val() + "&tarifa12=" + $("#total_p2").val() + "&iva=" + $("#iva").val() + "&desc=" + $("#desc").val() + "&tot=" + $("#tot").val() + "&ruc_ci=" + $("#ruc_ci").val() + "&nombre_cliente=" + $("#nombre_cliente").val() + "&direccion_cliente=" + $("#direccion_cliente").val() + "&telefono_cliente=" + $("#telefono_cliente").val() + "&correo=" + $("#correo").val() + "&campo1=" + string_v1 + "&campo2=" + string_v2 + "&campo3=" + string_v3 + "&campo4=" + string_v4 + "&campo5=" + string_v5+ "&campo6=" + string_v6+ "&tipo_venta=" + $("#tipo_venta").val(),
//                                    success: function(data) {
//                                        var val = data;
//                                        if($("#tipo_venta").val() == "FACTURA") {
//                                           if (val != 0) {
...
function volver_rf() {
    $.ajax({
        ...
        data: "id_guia_remision=" + $("#id_guia_remision").val(),
        success: function (data) {
            var val = data;
            val = val.split("-");
            if (val[0] != "") {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (val != "") {
                ...
                // $("#num_factura").attr("disabled", true);
                $("#btnGuiaRemision").attr("disabled", false);
                $("#id_cliente").val("");
                $("#ruc_ci").val("");
                $("#nombre_cliente").val("");
                $("#telefono_cliente").val("");
...
function inicio() {
    ...
    $("#btnActualizartrans").on("click", actualizar_transportista);
    $('#fecha_actual').val(new Date().toLocaleDateString("fr-CA"));
    $("#fecha_ini_transporte")[0].min = $("#fecha_actual").val();
    $("#fecha_fin_transporte")[0].min = $("#fecha_actual").val();

    $("#fecha_ini_transporte").val($("#fecha_actual").val());
    $("#fecha_fin_transporte").val($("#fecha_actual").val());
    ...
    $("#id_guia_remision").change(function (e) {
        if ($(this).val() != "") {
            ...
            .jqGrid({
                ...
                ondblClickRow: function () {
                    ...
                    /* var id = jQuery("#list2").jqGrid("getGridParam", "selrow");
                     ...
                     if (id) {
                     var ret = jQuery("#list2").jqGrid("getRowData", id);
                     var valor = ret.id_guia_remision;
    ...
    $("#btnImprimirGuia").click(function () {
        ...
        myWindow.print();
            ...
            alertify.error("Error... Debe buscar una Guía");
        }
    });
...
//                type: "POST",
//                url: "guardar_ret_fuente_fact_venta.php",
//                data: "id_factura=" + $("#id_guia_remision").val() + "&id_retencion_fuente=" + x + "&valor_factura=" + $("#tot").val() + "&iva_factura=" + $("#iva").val() + "&valor_retencion=" + $("#calculoRetencionF").val() + "&autorizacion_ret=" + $("#autorizacion_retencion").val(),
//                success: function (data) {
//                    var val = data;
//                    if (val == 1) {
...
//                data: "id_factura=" + $("#id_guia_remision").val() + "&id_retencion_iva=" + y + "&valor_factura=" + $("#tot").val() + "&iva_factura=" + $("#iva").val() + "&valor_retencion=" + $("#calculoRetencionI").val() + "&autorizacion_ret=" + $("#autorizacion_retencion").val(),
//                success: function (data) {
//                    var val1 = data;
//                    if (val1 == 1) {
//                        alertify.alert("Retenciones guardadas correctamente", function () {
...
function actualizar_compro() {
    ...
    if ($("#num_serie_guia").val() == "") {
        ...
        var res = parseInt(str.substr(4, 16));
        res = res + 1;
        $("#num_oculto_guia").val(res);
        var a = autocompletar_guia_num(res);
        var validado = a + "" + res;
        $("#num_serie_guia").val(validado);
...
function guardar_guia_remision() {
    ...
    if ($("#destino").val() == "") {
        $("#destino").focus();
        alertify.alert("Ingresar Destino");
    } else {
        if ($("#tipo_motivo").val() == "") {
            $("#tipo_motivo").focus();
            alertify.alert("Ingresar Motivo");
        } else {
            if ($("#num_serie_guia").val() == "") {
                $("#num_serie_guia").focus();
                ...
                if (tam.length == 0) {
                    ...
                    $("#codigo_barras").focus();
                    alertify.error( "Error... Ingrese productos a la Guía de Remisión" );
                } else {
                    $("#btnGuiaRemision").attr("disabled", true);
                    var v1 = new Array();
                    var v2 = new Array();
                            ...
                            if (val < 0) {
                                ...
                                $.ajax({
                                    ...
                                    data:
                                            ...
                                            $("#id_cliente").val() +
                                            "&fecha_inicio=" +
                                            $("#fecha_ini_transporte").val() +
                                            "&fecha_fin=" +
                                            $("#fecha_fin_transporte").val() +
                                            "&punto_partida=" +
                                            $("#punto_partida").val() +
                                            "&destino=" +
                                            $("#destino").val(),
                                    ...
                                    success: function (data) {
                                        ...
                                        if (data.estado == 2) {
                                            ...
                                            if (data.estado == 22) {
                                                alertify.alert("Guia de Remisión Guardada  No Autorizada", function () {
                                                    location.reload();
                                                });
                                            } else {
                                                if (data.estado == 8) {
                                                    alertify.alert("FALLIDA CONEXION SRI, VUELVA A INTENTAR DESDE ESTADOS FACTURACION", function () {
                                                        location.reload();
                                                    });
                                                }
                                            }
...
function llenarValoresPagosNC() {
    ...
    valoresNotaCreditoSel.forEach(el => {
        ...
        let datarow = {
            id_f_v_mix: count,
            id_guia_remision: $("#comprobante").val(),
            fecha: $("#fecha_actual").val(),
            forma_pago_mixto: $("#formaspago_mixto").val(),
            tarjeta_credito: $("#tarjetas").val(),
