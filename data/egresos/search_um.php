...
if ($unidad_medida != "") {
    $consulta1 = pg_query("
  select p.cod_productos,p.iva,cantidad, precio_compra, iva_minorista, pvpnego,precio_compra from productos p left join unidad_medida_productos ump on p.cod_productos=ump.cod_productos 
