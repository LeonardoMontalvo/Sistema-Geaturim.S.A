            ...
            <div class="col-md-12">
              <div class="box box-primary">
                <div class="box-body">
                  ...
                  <div class="tabbable" id="patrimonio">
                    <h4>
                      3. Patrimonio
                    </h4>
                      <!-- <fieldset> -->
                  ...
                  <div class="tabbable" id="ingresos">
                    <h4>
                      4. Ingresos
                    </h4>
                      <!-- <fieldset> -->
