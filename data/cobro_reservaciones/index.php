...
<html>
  <head>
    <meta charset="UTF-8">
    <title>COBRO RESERVACIONES</title>
              ...
              <div class="box box-primary">
                <div class="box-body">
                               ...
                               <div class="col-mx-12">
                                  ...
                                  <div class="col-md-2">
                                    <div class="form-group">
                                      ...
                                      <button class="btn btn-primary" id='btnGuardar'><i class="fa fa-save"></i> Ingresar</button>
                                    </div> 
                                  </div>
                               </div>
                              </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <p>
                        <button class="btn bg-olive margin" id='btnfacturas'><i class="fa fa-new"></i> Buscar Reservaciones</button>
                        ...
                        <button class="btn bg-olive margin" id='btnUltimo'><i class="fa fa-print"></i> Último Pago</button>
                      </p> 
                    </div>
                  </div>

                  <div id="buscar_reservaciones" title="BUSCAR FACTURAS">
                      <fieldset>
