...
if (!$sidx)
    $sidx = 1;
$result = pg_query("SELECT COUNT(*) AS count FROM plan_cuentas where  codigo_plan like '5.2%' and cuenta='M'");
...
if ($search == 'false') {
    $SQL = "select * from plan_cuentas where  codigo_plan like '5.2%' and cuenta='M' ORDER BY $sidx $sord offset $start limit $limit";
} else {
