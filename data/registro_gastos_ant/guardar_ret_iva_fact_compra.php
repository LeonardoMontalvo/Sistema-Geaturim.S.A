...
while ($row2 = pg_fetch_row($comprobar)) {
    if ($row2[0] == $_POST[id_gastos]) {
        $data = 2;
    }
}
if ($data != 2) {
    pg_query("insert into retencion_iva_factura_compra values('" . $cont1 . "', '$_POST[id_gastos]', '$_POST[id_retencion_iva]','" . $fecha . "','" . $hora . "','$_POST[valor_factura]','$_POST[iva_factura]','$_POST[valor_retencion]', '$_POST[autorizacion_ret]','','','$_POST[id_gastos]')");
