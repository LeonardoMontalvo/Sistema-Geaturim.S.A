...
if($_GET['id']==""&&$_GET['s1']==""&&$_GET['s2']==""&&$_GET['f1']==""&&$_GET['f2']=="")
  {
     ...
     $SQL = "SELECT FV.id_factura_venta, FV.fecha_actual, C.nombres_cli, FV.num_autorizacion, FV.total_venta::float, FV.estado_fac FROM factura_venta FV, clientes C where C.id_cliente = FV.id_cliente  and FV.estado_fac='7' ORDER BY  $sidx $sord offset $start limit $limit";
