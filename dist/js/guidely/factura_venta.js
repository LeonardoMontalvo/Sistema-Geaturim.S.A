...
///////////tabla local/////////////   
    ...
    jQuery("#list").jqGrid({
        ...
        colModel: [
            ...
            {name: 'precio_u', index: 'precio_u', editable: false, search: false, frozen: true, editrules: {required: true}, align: 'center', width: 110, editoptions:{maxlength: 10, size:15,dataInit: function(elem){$(elem).on("keypress", function(e) {return punto(e)})}}}, 
 ...
 //////////////////////series factura venta/////////////////////////
    jQuery("#list3").jqGrid({
     ...
     ////////////////////buscador proformas/////////////////////////
        ...
        $.getJSON('../procesos/retornar_proforma.php?id2=' + valor, function(data) {
            var tama = data.length;
            if (tama === 0) {
                alertify.alert("Error... La proforma no existe", function(){
                    location.reload();
                ...
                for (var i = 0; i < tama; i = i + 9) {
                    ...
                    // flotante = parseFloat(descuento);
                    // resultado = (Math.round(flotante * Math.pow(10,2)) / Math.pow(10,2)).toFixed(2);
                    // total = (parseFloat(multi - resultado)).toFixed(2);
