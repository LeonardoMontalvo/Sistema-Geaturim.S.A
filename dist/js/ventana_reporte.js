...
function reporte_cliente_producto(e) {
    ...
    .autocomplete({
      ...
      minLength: 1,
      focus: function (event, ui) {
        $("#buscarProductohcpp").val(ui.item.value);
        $("#idProd").val(ui.item.id_cliente);
      ...
      return $("<li>")
        ...
        $("#buscarClientecp")
            .autocomplete({
                ...
                minLength: 1,
                focus: function (event, ui) {
                    $("#buscarClientecp").val(ui.item.value);
                    $("#idclientes").val(ui.item.id_cliente);
...
function fn_reporte_cliente_producto(e) {
    if ($("#fin").val() === "" ) {
        ...
        window.open(
                "../../reportes/cliente_productos.php?idProd=" +
                $("#idProd").val() +
                "&idclientes=" +
                $("#idclientes").val()+
                "&inicio=" +
