...
if ($contador > 0) {
    while ($row1 = pg_fetch_row($consulta1)) {
        ...
        $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue("F" . $y, utf8_decode(truncateFloat(round($row1[8] - $row1[6] + $row1[7], 2, PHP_ROUND_HALF_EVEN), 2)))
            ->setCellValue("G" . $y, utf8_decode(truncateFloat(round($row1[7], 2, PHP_ROUND_HALF_EVEN), 2)))
            ->setCellValue("H" . $y, utf8_decode(truncateFloat(round($row1[4], 2, PHP_ROUND_HALF_EVEN), 2)))
            ->setCellValue("I" . $y, utf8_decode(truncateFloat(round($row1[5], 2, PHP_ROUND_HALF_EVEN), 2)))
            ->setCellValue("J" . $y, utf8_decode(truncateFloat(round($row1[6], 2, PHP_ROUND_HALF_EVEN), 2)))
