...
abstract class RuleSet implements Renderable, Commentable {
	 ...
	 * @param (null|string|Rule) $mRule pattern to search for. If null, returns all rules. if the pattern ends with a dash, all rules starting with the pattern are returned as card card-body as one matching the pattern with the dash excluded. passing a Rule behaves like calling getRules($mRule->getRule()).
	 ...
	 * @param (string) $mRule pattern to search for. If null, returns all rules. if the pattern ends with a dash, all rules starting with the pattern are returned as card card-body as one matching the pattern with the dash excluded. passing a Rule behaves like calling getRules($mRule->getRule()).
 ...
 * @param (null|string|Rule) $mRule pattern to remove. If $mRule is null, all rules are removed. If the pattern ends in a dash, all rules starting with the pattern are removed as card card-body as one matching the pattern with the dash excluded. Passing a Rule behaves matches by identity.
	*/
