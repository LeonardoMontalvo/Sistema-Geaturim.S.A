...
//////////////////////CABECERA DE LA CONSULTA
$objPHPExcel->setActiveSheetIndex(0)
        ->setCellValue("B2", 'REPORTE DE PRODUCTOS POR MARCAS');
$objPHPExcel->getActiveSheet()
...
$sql = pg_query("SELECT p.codigo,p.cod_barras,p.articulo,p.iva_minorista,p.iva_mayorista,p.stock,m.nombre_marca "
        . "FROM productos p INNER JOIN marcas m ON m.id_marca = p.id_marca "
        . "WHERE m.id_marca='$_GET[marca]'");
...
while ($row = pg_fetch_row($sql)) {
    ...
    $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue("G" . $y, $marcas->obtenerMarca($_GET['marca']));
