...
if ($_GET['marca'] == "" && $_GET['categoria'] == "") {
    $sql = pg_query("SELECT codigo,cod_barras,articulo,iva_minorista,iva_mayorista,stock,id_categoria,id_marca FROM productos");
}
if ($_GET['marca'] == "" && $_GET['categoria'] != "") {
    $sql = pg_query("SELECT codigo,cod_barras,articulo,iva_minorista,iva_mayorista,stock,id_categoria,id_marca FROM productos WHERE id_categoria='$_GET[categoria]'");
}
if ($_GET['marca'] != "" && $_GET['categoria'] == "") {
    $sql = pg_query("SELECT codigo,cod_barras,articulo,iva_minorista,iva_mayorista,stock,id_categoria,id_marca FROM productos WHERE id_marca='$_GET[marca]'");
}
if ($_GET['marca'] != "" && $_GET['categoria'] != "") {
    $sql = pg_query("SELECT codigo,cod_barras,articulo,iva_minorista,iva_mayorista,stock,id_categoria,id_marca FROM productos "
            . "WHERE id_categoria='$_GET[categoria]' AND id_marca='$_GET[marca]'");
}
...
while ($row = pg_fetch_row($sql)) {
    ...
    $objPHPExcel->setActiveSheetIndex(0)
            ...
            ->setCellValue("H" . $y, $marca->obtenerMarca($_GET['marca']));
