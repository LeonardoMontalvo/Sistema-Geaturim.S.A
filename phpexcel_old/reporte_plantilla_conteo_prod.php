...
$objPHPExcel->getProperties()->setCreator("SYSWEB")
        ->setLastModifiedBy("SYSWEB")
...
$sql = pg_query("select cod_barras,codigo,articulo
from productos p
...
$objPHPExcel->setActiveSheetIndex(0)
        ->getStyle('B' . $y2 . ":D" . $y2)
        ->applyFromArray($borders2);

$objPHPExcel->setActiveSheetIndex(0)
        ->setCellValue("B" . $y2, '')
        ->setCellValue("C" . $y2, '')
        ->setCellValue("D" . $y2, "=SUM(D7:D$y)");
